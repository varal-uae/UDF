/*
 * SGTIM-021-A03 — Primary Field Row Mapper
 * 
 * Global Reference ID: SGTIM-021
 * Atomic Steps Reference ID: SGTIM-021-A03
 * Atomic Step: Map high-level primary fields into the main row framework for immediate reading visibility.
 * Tab Name: SGTIM-021-A03 - UIUX | Row Tab Name: UDF
 * S.No: 12.0 | Sequence Order: 39717 | Assigned Team Member: Pooja | Group: UDF | Decision Group: Data Visualization.
 ...
 * Target System: AISS Implementation — Primary Field Row Mapper
 * Backend Models: UserFlowNode (tbl_user_flow_nodes), UserFlowComplianceSummary (tbl_user_flow_compliance_summary), BQGraphCheckpointMetadata (tbl_bq_graph_checkpoint_metadata), DeadLetterQuarantine (q_dead_letter_quarantine), ExecutionAuditLog (tbl_execution_audit_log)
 * API Endpoint: POST /api/v1/layout/primary-field-row-mapper/validate/
...
/// Row 220: SGTIM-021 (Seq 39717)
/// Action: Map high-level primary fields into the main row framework for immediate reading visibility.
...
class PrimaryFieldRowMapperPanel extends StatefulWidget {
  final String globalRefId;
  final String atomicStepRefId;
  final int sequenceOrder;

  const PrimaryFieldRowMapperPanel({
    super.key,
    this.globalRefId = 'SGTIM-021',
    this.atomicStepRefId = 'SGTIM-021-A03',
    this.sequenceOrder = 39717,
  });

  @override
  State<PrimaryFieldRowMapperPanel> createState() =>
      _PrimaryFieldRowMapperPanelState();
}

class _PrimaryFieldRowMapperPanelState
    extends State<PrimaryFieldRowMapperPanel> {
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        '${widget.globalRefId}: Primary Field Row Mapper',
              ...
              child: FilledButton.icon(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                          'Primary summary fields mapped into high-visibility main row framework layout.'),
      ...
      home: Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: PrimaryFieldRowMapperPanel(),
          ),
        ),
      ),
    ),
