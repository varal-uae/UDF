/*
 * TNRML-004-A04 — Tablet Left Nav Rail Panel
 * 
 * Global Reference ID: TNRML-004
 * Atomic Steps Reference ID: TNRML-004-A04
 * Atomic Step: Implement the rail as a left-aligned navigation component for tablets.
 * Tab Name: TNRML-004-A04 - UIUX | Row Tab Name: UDF
 * S.No: 16.0 | Sequence Order: 42816 | Assigned Team Member: Pooja | Group: UDF | Decision Group: Dashboard.
 ...
 * Target System: AISS Implementation — Tablet Left Nav Rail Panel
 * Backend Models: UserFlowNode (tbl_user_flow_nodes), UserFlowComplianceSummary (tbl_user_flow_compliance_summary), BQGraphCheckpointMetadata (tbl_bq_graph_checkpoint_metadata), DeadLetterQuarantine (q_dead_letter_quarantine), ExecutionAuditLog (tbl_execution_audit_log)
 * API Endpoint: POST /api/v1/navigation/tablet-left-nav-rail-panel/validate/
...
/// Row 340: TNRML-004 (Seq 42816)
/// Action: Implement the rail as a left-aligned navigation component for tablets.
...
class TabletLeftNavRailPanel extends StatefulWidget {
  final String globalRefId;
  final String atomicStepRefId;
  final int sequenceOrder;

  const TabletLeftNavRailPanel({
    super.key,
    this.globalRefId = 'TNRML-004',
    this.atomicStepRefId = 'TNRML-004-A04',
    this.sequenceOrder = 42816,
  });

  @override
  State<TabletLeftNavRailPanel> createState() =>
      _TabletLeftNavRailPanelState();
}

class _TabletLeftNavRailPanelState
    extends State<TabletLeftNavRailPanel> {
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        '${widget.globalRefId}: Tablet Left Nav Rail Panel',
              ...
              child: FilledButton.icon(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                          'Left-aligned NavigationRail component instantiated for tablet viewports.'),
