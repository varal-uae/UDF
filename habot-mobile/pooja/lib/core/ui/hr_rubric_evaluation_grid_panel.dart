    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final cardMargin = EdgeInsets.symmetric(
          horizontal: isCompact ? HrRubricEvaluationGridPanelTokens.xs : (isExpanded ? HrRubricEvaluationGridPanelTokens.md : HrRubricEvaluationGridPanelTokens.sm),
          vertical: HrRubricEvaluationGridPanelTokens.xs,
        );
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    HrRubricEvaluationGridPanelTokens.hGapSm,
                    Expanded(
                      child: Text(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: HrRubricEvaluationGridPanelTokens.success.withValues(alpha: 0.14),
                        borderRadius: BorderRadius.circular(6),
                        border: Border.all(color: HrRubricEvaluationGridPanelTokens.success),
                      ),
                      child: Text(
                        'AI CONFIDENCE: ${record.completionStatus.toUpperCase()}',
                        style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: HrRubricEvaluationGridPanelTokens.success),
                      ),
                    ),
                  ],
                ),
                HrRubricEvaluationGridPanelTokens.vGapMd,

                // Architectural Overview Banner
                Container(
                  padding: HrRubricEvaluationGridPanelTokens.paddingMd,
                  decoration: BoxDecoration(
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: HrRubricEvaluationGridPanelTokens.brandPrimary.withValues(alpha: 0.1),
                              borderRadius: BorderRadius.circular(4),
                            ),
                            child: const Text('NIST AI RMF 1.0', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: HrRubricEvaluationGridPanelTokens.brandPrimary)),
                          ),
                        ],
                      ),
                      HrRubricEvaluationGridPanelTokens.vGapXs,
                      Text(
                ...
                HrRubricEvaluationGridPanelTokens.vGapLg,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text('Score: ${dim.score}/5.0 (Conf: ${(dim.confidenceScore * 100).round()}%)',
                                                style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: HrRubricEvaluationGridPanelTokens.success)),
                                          ],
                                        ),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text('AI Confidence: ${(activeDim.confidenceScore * 100).round()}%',
                                style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: HrRubricEvaluationGridPanelTokens.brandPrimary)),
                          ],
                        ),
                      ),
                    ],
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      HrRubricEvaluationGridPanelTokens.vGapSm,
                      Row(
                        children: [
                          _buildMetricTile(context, 'Floor Boundary', record.floorBoundary, HrRubricEvaluationGridPanelTokens.warning),
                          _buildMetricTile(context, 'Optimal Target', record.optimalTarget, HrRubricEvaluationGridPanelTokens.info),
                          _buildMetricTile(context, 'Ceiling Boundary', record.ceilingBoundary, HrRubricEvaluationGridPanelTokens.success),
                          _buildMetricTile(context, 'Gate Status', 'HIGH (0.94 Conf)', HrRubricEvaluationGridPanelTokens.brandPrimary),
                        ],
                      ),
                    ],
                  ),
...
// ============================================================================
abstract final class HrRubricEvaluationGridPanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: HrRubricEvaluationGridPanel(
