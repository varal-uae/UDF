...
class _MobileBytDataAttributeCardPanelState
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: MobileBytDataAttributeCardPanelTokens.paddingLg,
      decoration: BoxDecoration(
        color: colorScheme.surface,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: MobileBytDataAttributeCardPanelTokens.lightOutline.withValues(alpha: 0.2)),
      ),
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                padding: const EdgeInsets.all(MobileBytDataAttributeCardPanelTokens.sm),
                decoration: BoxDecoration(
                  color: MobileBytDataAttributeCardPanelTokens.brandPrimaryContainer,
                  borderRadius: BorderRadius.circular(8),
                ),
                child: const Icon(
                  Icons.badge_outlined,
                  color: MobileBytDataAttributeCardPanelTokens.brandPrimary,
                  size: 24,
                ),
              ),
              MobileBytDataAttributeCardPanelTokens.hGapMd,
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: MobileBytDataAttributeCardPanelTokens.successContainer,
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  'Orphan: 0%',
                  style: theme.textTheme.labelSmall?.copyWith(
                    color: MobileBytDataAttributeCardPanelTokens.onSuccessContainer,
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ),
          ...
          MobileBytDataAttributeCardPanelTokens.vGapMd,
          // Task Card UI with Read-Only Body Fields
          Card(
            elevation: 4,
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
            child: Padding(
              padding: MobileBytDataAttributeCardPanelTokens.paddingMd,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(Icons.lock, size: 16, color: MobileBytDataAttributeCardPanelTokens.brandPrimary),
                          MobileBytDataAttributeCardPanelTokens.hGapXs,
                      ...
                      Container(
                        ...
                        child: const Text('READ-ONLY BOUND', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: MobileBytDataAttributeCardPanelTokens.onBrandPrimaryContainer)),
                      ),
                    ],
                  ),
                  MobileBytDataAttributeCardPanelTokens.vGapSm,
                  Divider(color: MobileBytDataAttributeCardPanelTokens.lightOutline.withValues(alpha: 0.15)),
                  MobileBytDataAttributeCardPanelTokens.vGapSm,
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  ...
                  backgroundColor: MobileBytDataAttributeCardPanelTokens.success,
                ),
              );
            },
...
// ============================================================================
abstract final class MobileBytDataAttributeCardPanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: MobileBytDataAttributeCardPanel(),
          ),
        ),
      ),
    ),
