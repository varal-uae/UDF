...
class _RollbackNotificationDialogPanelState
  ...
  void _showHighVisibilityRollbackDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        icon: const Icon(Icons.history_toggle_off, color: RollbackNotificationDialogPanelTokens.warning, size: 36),
        ...
        content: Column(
          ...
          children: [
            Container(
              padding: RollbackNotificationDialogPanelTokens.paddingSm,
              decoration: BoxDecoration(
                color: RollbackNotificationDialogPanelTokens.warningContainer.withValues(alpha: 0.5),
            ...
            RollbackNotificationDialogPanelTokens.vGapSm,
            const Text(
  ...
  void _showRollbackSnackbar(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: RollbackNotificationDialogPanelTokens.warning,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: RollbackNotificationDialogPanelTokens.paddingLg,
      decoration: BoxDecoration(
        color: colorScheme.surface,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: RollbackNotificationDialogPanelTokens.lightOutline.withValues(alpha: 0.2)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Container(
                padding: const EdgeInsets.all(RollbackNotificationDialogPanelTokens.sm),
                decoration: BoxDecoration(
                  color: RollbackNotificationDialogPanelTokens.brandPrimaryContainer,
                  borderRadius: BorderRadius.circular(8),
                ),
                child: const Icon(
                  Icons.notification_important_outlined,
                  color: RollbackNotificationDialogPanelTokens.brandPrimary,
                  size: 24,
                ),
              ),
              RollbackNotificationDialogPanelTokens.hGapMd,
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: RollbackNotificationDialogPanelTokens.successContainer,
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  'M3 Adherence: 100%',
                  style: theme.textTheme.labelSmall?.copyWith(
                    color: RollbackNotificationDialogPanelTokens.onSuccessContainer,
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ),
          ...
          RollbackNotificationDialogPanelTokens.vGapMd,
          Container(
            padding: RollbackNotificationDialogPanelTokens.paddingMd,
            decoration: BoxDecoration(
          ...
          Row(
            children: [
              ...
              RollbackNotificationDialogPanelTokens.hGapSm,
              OutlinedButton.icon(
...
// ============================================================================
abstract final class RollbackNotificationDialogPanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: RollbackNotificationDialogPanel(),
          ),
        ),
      ),
    ),
