    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final cardPadding = isCompact
            ? ScannableUserTokenReplacementPanelTokens.paddingSm
            : (isExpanded ? ScannableUserTokenReplacementPanelTokens.paddingLg : ScannableUserTokenReplacementPanelTokens.paddingMd);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: ScannableUserTokenReplacementPanelTokens.brandPrimary.withValues(alpha: 0.12),
                        shape: BoxShape.circle,
                      ),
                      child: const Icon(Icons.qr_code_2_rounded,
                          color: ScannableUserTokenReplacementPanelTokens.brandPrimary, size: 22),
                    ),
                    ScannableUserTokenReplacementPanelTokens.hGapMd,
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(
                            ...
                            style: theme.textTheme.titleMedium?.copyWith(
                              ...
                              color: ScannableUserTokenReplacementPanelTokens.brandPrimary,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _adherenceScore >= 0.95
                            ? ScannableUserTokenReplacementPanelTokens.successContainer
                            : ScannableUserTokenReplacementPanelTokens.warningContainer,
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          color: _adherenceScore >= 0.95
                              ? ScannableUserTokenReplacementPanelTokens.onSuccessContainer
                              : ScannableUserTokenReplacementPanelTokens.onWarningContainer,
                        ),
                      ),
                    ),
                  ],
                ),
                ScannableUserTokenReplacementPanelTokens.vGapMd,
                ...
                ScannableUserTokenReplacementPanelTokens.vGapXs,
                Text(
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                color: _showRawInternalKeys
                                    ? ScannableUserTokenReplacementPanelTokens.error
                                    : ScannableUserTokenReplacementPanelTokens.success,
                              ),
                            ),
                          ],
                        ),
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.token_rounded,
                              size: 20, color: ScannableUserTokenReplacementPanelTokens.brandPrimary),
                                ...
                                if (_showRawInternalKeys) ...[
                                  ...
                                  Text(
                                    ...
                                    style: const TextStyle(
                                      ...
                                      color: ScannableUserTokenReplacementPanelTokens.error,
                                    ),
                                  ),
                                ],
                              ],
                          ...
                          ConstrainedBox(
                            ...
                            child: ActionChip(
                              ...
                              backgroundColor: ScannableUserTokenReplacementPanelTokens.brandPrimaryContainer,
...
// ============================================================================
abstract final class ScannableUserTokenReplacementPanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: ScannableUserTokenReplacementPanel(),
          ),
        ),
      ),
    ),
