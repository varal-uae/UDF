    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final contentPadding = isCompact
            ? AtomicTaskMappingPanelTokens.paddingSm
            : (isExpanded ? AtomicTaskMappingPanelTokens.paddingLg : AtomicTaskMappingPanelTokens.paddingMd);
              ...
              children: [
                Row(
                  children: [
                    ...
                    AtomicTaskMappingPanelTokens.hGapMd,
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                ...
                AtomicTaskMappingPanelTokens.vGapMd,
                ...
                AtomicTaskMappingPanelTokens.vGapXs,
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      color: task.isComplete
                          ? colorScheme.surface
                          : AtomicTaskMappingPanelTokens.brandPrimary.withValues(alpha: 0.05),
                      borderRadius: BorderRadius.circular(6),
                      border: Border.all(
                        color: task.isComplete
                            ? colorScheme.outlineVariant
                            : AtomicTaskMappingPanelTokens.brandPrimary,
                      ),
                    ),
                    child: Row(
                      children: [
                        Icon(
                          ...
                          color: task.isComplete ? AtomicTaskMappingPanelTokens.success : AtomicTaskMappingPanelTokens.brandPrimary,
                          size: 18,
                        ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: _isWorkflowComplete ? AtomicTaskMappingPanelTokens.brandPrimary : null,
                ...
                AtomicTaskMappingPanelTokens.vGapMd,
                Container(
                  padding: AtomicTaskMappingPanelTokens.paddingSm,
                  decoration: BoxDecoration(
...
// ============================================================================
abstract final class AtomicTaskMappingPanelTokens {
