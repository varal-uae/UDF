    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final horizontalPadding = isExpanded
            ? DragDropDocumentLandingPanelTokens.paddingXl
            : (isCompact ? DragDropDocumentLandingPanelTokens.paddingSm : DragDropDocumentLandingPanelTokens.paddingMd);
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    DragDropDocumentLandingPanelTokens.hGapMd,
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                ...
                DragDropDocumentLandingPanelTokens.vGapMd,
                ...
                DragDropDocumentLandingPanelTokens.vGapSm,
                ...
                Row(
                  children: [
                    ...
                    DragDropDocumentLandingPanelTokens.hGapSm,
                    Expanded(
                      child: OutlinedButton.icon(
                ...
                DragDropDocumentLandingPanelTokens.vGapXs,
                ...
                Container(
                  padding: DragDropDocumentLandingPanelTokens.paddingSm,
                  decoration: BoxDecoration(
...
// ============================================================================
abstract final class DragDropDocumentLandingPanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: DragDropDocumentLandingPanel(),
          ),
        ),
      ),
    ),
