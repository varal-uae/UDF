    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final horizontalPadding = isExpanded
            ? KeydownInputInterceptorPanelTokens.paddingXl
            : (isCompact ? KeydownInputInterceptorPanelTokens.paddingSm : KeydownInputInterceptorPanelTokens.paddingMd);
              ...
              children: [
                Row(
                  children: [
                    ...
                    KeydownInputInterceptorPanelTokens.hGapMd,
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                ...
                KeydownInputInterceptorPanelTokens.vGapMd,

                Text(
                  'Hardware-Level Numeric Interceptor (Poka-Yoke Col AD)',
                  style: theme.textTheme.labelMedium?.copyWith(fontWeight: FontWeight.bold),
                ),
                KeydownInputInterceptorPanelTokens.vGapXs,
                TextField(
                ...
                KeydownInputInterceptorPanelTokens.vGapMd,
                Container(
                  padding: KeydownInputInterceptorPanelTokens.paddingSm,
                  decoration: BoxDecoration(
...
// ============================================================================
abstract final class KeydownInputInterceptorPanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: KeydownInputInterceptorPanel(),
          ),
        ),
      ),
    ),
