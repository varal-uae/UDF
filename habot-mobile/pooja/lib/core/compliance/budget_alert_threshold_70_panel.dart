    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final cardPadding = isCompact
            ? BudgetAlertThreshold70PanelTokens.paddingSm
            : (isExpanded ? BudgetAlertThreshold70PanelTokens.paddingLg : BudgetAlertThreshold70PanelTokens.paddingMd);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: BudgetAlertThreshold70PanelTokens.warning.withValues(alpha: 0.12),
                        shape: BoxShape.circle,
                      ),
                      child: const Icon(Icons.notifications_active_rounded,
                          color: BudgetAlertThreshold70PanelTokens.warning, size: 22),
                    ),
                    BudgetAlertThreshold70PanelTokens.hGapMd,
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(
                            ...
                            style: theme.textTheme.titleMedium?.copyWith(
                              ...
                              color: BudgetAlertThreshold70PanelTokens.brandPrimary,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isTriggered
                            ? BudgetAlertThreshold70PanelTokens.warningContainer
                            : BudgetAlertThreshold70PanelTokens.successContainer,
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          color: isTriggered
                              ? BudgetAlertThreshold70PanelTokens.onWarningContainer
                              : BudgetAlertThreshold70PanelTokens.onSuccessContainer,
                        ),
                      ),
                    ),
                  ],
                ),
                BudgetAlertThreshold70PanelTokens.vGapMd,
                ...
                BudgetAlertThreshold70PanelTokens.vGapXs,
                Text(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: isTriggered ? BudgetAlertThreshold70PanelTokens.warning : BudgetAlertThreshold70PanelTokens.success,
                            ),
                          ),
                        ],
                      ),
                      Slider(
                        ...
                        activeColor: isTriggered ? BudgetAlertThreshold70PanelTokens.warning : BudgetAlertThreshold70PanelTokens.brandPrimary,
                      ...
                      LinearProgressIndicator(
                        ...
                        valueColor: AlwaysStoppedAnimation<Color>(
                          isTriggered ? BudgetAlertThreshold70PanelTokens.warning : BudgetAlertThreshold70PanelTokens.brandPrimary,
                        ),
                      ),
                    ],
                  ),
                ...
                if (isTriggered)
                  Container(
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(
                      color: BudgetAlertThreshold70PanelTokens.warningContainer.withValues(alpha: 0.6),
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(color: BudgetAlertThreshold70PanelTokens.warning),
                    ),
                    child: Row(
                      children: [
                        const Icon(Icons.info_outline_rounded, color: BudgetAlertThreshold70PanelTokens.warning, size: 22),
                            ...
                            children: [
                              const Text(
                                ...
                                style: TextStyle(
                                  fontSize: 11,
                                  fontWeight: FontWeight.bold,
                                  color: BudgetAlertThreshold70PanelTokens.onWarningContainer,
                                ),
                              ),
                              Text(
                                'Variance: +${thresholdDelta.toStringAsFixed(1)}% above 70% limit. Non-blocking advisory notice.',
                                style: const TextStyle(fontSize: 10, color: BudgetAlertThreshold70PanelTokens.onWarningContainer),
                              ),
                            ],
                          ),
                        ),
                        if (!_alertAcknowledged)
                          ...
                          const Icon(Icons.check, size: 18, color: BudgetAlertThreshold70PanelTokens.success),
                      ],
                    ),
                  ),
                BudgetAlertThreshold70PanelTokens.vGapMd,
...
// ============================================================================
abstract final class BudgetAlertThreshold70PanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: BudgetAlertThreshold70Panel(),
          ),
        ),
      ),
    ),
