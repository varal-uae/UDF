    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final contentPadding = isCompact
            ? NumericalFinancialRegexPanelTokens.paddingSm
            : (isExpanded ? NumericalFinancialRegexPanelTokens.paddingLg : NumericalFinancialRegexPanelTokens.paddingMd);
              ...
              children: [
                Row(
                  children: [
                    ...
                    NumericalFinancialRegexPanelTokens.hGapMd,
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                ...
                NumericalFinancialRegexPanelTokens.vGapMd,
                ...
                NumericalFinancialRegexPanelTokens.vGapXs,
                TextField(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: _isValidCurrency ? NumericalFinancialRegexPanelTokens.brandPrimary : null,
                ...
                NumericalFinancialRegexPanelTokens.vGapMd,
                Container(
                  padding: NumericalFinancialRegexPanelTokens.paddingSm,
                  decoration: BoxDecoration(
...
// ============================================================================
abstract final class NumericalFinancialRegexPanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: NumericalFinancialRegexPanel(),
          ),
        ),
      ),
    ),
