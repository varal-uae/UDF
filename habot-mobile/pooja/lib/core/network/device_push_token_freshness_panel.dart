...
class _DevicePushTokenFreshnessPanelState
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: DevicePushTokenFreshnessPanelTokens.paddingLg,
      decoration: BoxDecoration(
        color: colorScheme.surface,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: DevicePushTokenFreshnessPanelTokens.lightOutline.withValues(alpha: 0.2)),
      ),
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                padding: const EdgeInsets.all(DevicePushTokenFreshnessPanelTokens.sm),
                decoration: BoxDecoration(
                  color: DevicePushTokenFreshnessPanelTokens.brandPrimaryContainer,
                  borderRadius: BorderRadius.circular(8),
                ),
                child: const Icon(
                  Icons.phonelink_ring_outlined,
                  color: DevicePushTokenFreshnessPanelTokens.brandPrimary,
                  size: 24,
                ),
              ),
              DevicePushTokenFreshnessPanelTokens.hGapMd,
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: DevicePushTokenFreshnessPanelTokens.successContainer,
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  'Freshness: 97.4%',
                  style: theme.textTheme.labelSmall?.copyWith(
                    color: DevicePushTokenFreshnessPanelTokens.onSuccessContainer,
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ),
          ...
          DevicePushTokenFreshnessPanelTokens.vGapMd,
          Container(
            padding: DevicePushTokenFreshnessPanelTokens.paddingMd,
            decoration: BoxDecoration(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const Icon(Icons.lock, size: 14, color: DevicePushTokenFreshnessPanelTokens.success),
                        DevicePushTokenFreshnessPanelTokens.hGapXs,
                        Text(
                          'RLS Encrypted',
                          style: theme.textTheme.labelSmall?.copyWith(
                            color: DevicePushTokenFreshnessPanelTokens.success,
                            fontWeight: FontWeight.bold,
                          ),
                        ),
                      ],
                ...
                DevicePushTokenFreshnessPanelTokens.vGapSm,
                Text(
                  'Active Devices Holding Valid Token: 97.4% (Target: >=97.0%, Floor: 90.0%). Zero stale token dropouts detected.',
                  style: theme.textTheme.bodySmall,
                ),
                DevicePushTokenFreshnessPanelTokens.vGapSm,
                Divider(color: DevicePushTokenFreshnessPanelTokens.lightOutline.withValues(alpha: 0.15)),
                DevicePushTokenFreshnessPanelTokens.vGapSm,
                Text(
                  'Mobile Screen Display & Parsing Requirements:',
                  style: theme.textTheme.labelMedium?.copyWith(fontWeight: FontWeight.bold),
                ),
                DevicePushTokenFreshnessPanelTokens.vGapXs,
                ..._parsingRequirements.map((item) => Padding(
                  padding: const EdgeInsets.symmetric(vertical: 3.0),
                  child: Row(
                    children: [
                      const Icon(Icons.check_circle_outline, size: 16, color: DevicePushTokenFreshnessPanelTokens.success),
                      DevicePushTokenFreshnessPanelTokens.hGapSm,
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  ...
                  backgroundColor: DevicePushTokenFreshnessPanelTokens.success,
                ),
              );
            },
...
// ============================================================================
abstract final class DevicePushTokenFreshnessPanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: DevicePushTokenFreshnessPanel(),
          ),
        ),
      ),
    ),
