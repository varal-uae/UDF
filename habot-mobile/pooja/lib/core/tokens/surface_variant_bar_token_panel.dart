...
class _SurfaceVariantBarTokenPanelState
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: SurfaceVariantBarTokenPanelTokens.paddingLg,
      decoration: BoxDecoration(
        color: colorScheme.surface,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: SurfaceVariantBarTokenPanelTokens.lightOutline.withValues(alpha: 0.2)),
      ),
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                padding: const EdgeInsets.all(SurfaceVariantBarTokenPanelTokens.sm),
                decoration: BoxDecoration(
                  color: SurfaceVariantBarTokenPanelTokens.brandPrimaryContainer,
                  borderRadius: BorderRadius.circular(8),
                ),
                child: const Icon(
                  Icons.palette_outlined,
                  color: SurfaceVariantBarTokenPanelTokens.brandPrimary,
                  size: 24,
                ),
              ),
              SurfaceVariantBarTokenPanelTokens.hGapMd,
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: SurfaceVariantBarTokenPanelTokens.successContainer,
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  'M3: 100% (Good)',
                  style: theme.textTheme.labelSmall?.copyWith(
                    color: SurfaceVariantBarTokenPanelTokens.onSuccessContainer,
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ),
          ...
          SurfaceVariantBarTokenPanelTokens.vGapMd,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: SurfaceVariantBarTokenPanelTokens.lightSurfaceVariant,
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: SurfaceVariantBarTokenPanelTokens.lightOutlineVariant),
            ),
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.lock, size: 16, color: SurfaceVariantBarTokenPanelTokens.lightOnSurfaceVariant),
                    SurfaceVariantBarTokenPanelTokens.hGapSm,
                    Text(
                      'TLS 1.3 Encrypted Bar',
                      style: theme.textTheme.bodyMedium?.copyWith(
                        color: SurfaceVariantBarTokenPanelTokens.lightOnSurfaceVariant,
                        fontWeight: FontWeight.bold,
                      ),
                    ),
                  ],
          ...
          SurfaceVariantBarTokenPanelTokens.vGapMd,
          Container(
            padding: SurfaceVariantBarTokenPanelTokens.paddingMd,
            decoration: BoxDecoration(
            ...
            child: Column(
              ...
              children: [
                ...
                SurfaceVariantBarTokenPanelTokens.vGapSm,
                _buildInfoRow('Design Token Name', _tokenName, theme, colorScheme),
                SurfaceVariantBarTokenPanelTokens.vGapXs,
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  ...
                  backgroundColor: SurfaceVariantBarTokenPanelTokens.success,
                ),
              );
            },
...
// ============================================================================
abstract final class SurfaceVariantBarTokenPanelTokens {
      ...
      home: const Scaffold(
        body: SafeArea(
          child: SingleChildScrollView(
            child: SurfaceVariantBarTokenPanel(),
          ),
        ),
      ),
    ),
