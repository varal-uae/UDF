...
enum Rcgla012A08ExecutionStatus { pending, running, complete, failed }
...
class Rcgla012A08ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Rcgla012A08ConformanceLevel.pass_: return 'Pass';
      case Rcgla012A08ConformanceLevel.fail_: return 'Fail';
    }
  }
}
...
class Rcgla012A08Pipeline {
  ...
  static Rcgla012A08ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Rcgla012A08ValidationResult(
        ...
        conformanceRate: 0.0,
        conformanceLevel: Rcgla012A08ConformanceLevel.fail_,
        gatePass: false, ecLineRef: 'EC-RCGLA012A08-VAL',
      );
    }
    ...
    final level = rate >= _floor
        ? Rcgla012A08ConformanceLevel.pass_
        : Rcgla012A08ConformanceLevel.fail_;
    return Rcgla012A08ValidationResult(
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-RCGLA012A08-000: configs must not be empty for RCGLA-012-A08');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-RCGLA012A08-TRI: triangular check failed for RCGLA-012-A08');
    }
...
void main() async {
  final configs = [
    Rcgla012A08Config(
      ...
      gridColumns: 'rcgla-012-a08_gridColumns',
      gutterSizePx: 'rcgla-012-a08_gutterSizePx',
      maxWidthPx: 'rcgla-012-a08_maxWidthPx',
      breakpointLabel: 'rcgla-012-a08_breakpointLabel',
  ...
  final out = await Rcgla012A08Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('RCGLA-012-A08 [Pass / Fail] → $out');
}
