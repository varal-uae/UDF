...
enum Ref046A13ExecutionStatus { pending, running, complete, failed }
...
class Ref046A13ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Ref046A13ConformanceLevel.pass_: return 'Pass';
      case Ref046A13ConformanceLevel.fail_: return 'Fail';
    }
  }
}
...
class Ref046A13Pipeline {
  ...
  static Ref046A13ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Ref046A13ValidationResult(
        ...
        conformanceRate: 0.0,
        conformanceLevel: Ref046A13ConformanceLevel.fail_,
        gatePass: false, ecLineRef: 'EC-REF046A13-VAL',
      );
    }
    ...
    final level = rate >= _floor
        ? Ref046A13ConformanceLevel.pass_
        : Ref046A13ConformanceLevel.fail_;
    return Ref046A13ValidationResult(
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-REF046A13-000: configs must not be empty for REF-046-A13');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-REF046A13-TRI: triangular check failed for REF-046-A13');
    }
...
void main() async {
  final configs = [
    Ref046A13Config(
      ...
      modalId: 'ref-046-a13_modalId',
      triggerEvent: 'ref-046-a13_triggerEvent',
      contentType: 'ref-046-a13_contentType',
      dismissBehaviour: 'ref-046-a13_dismissBehaviour',
  ...
  final out = await Ref046A13Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('REF-046-A13 [Pass / Fail] → $out');
}
