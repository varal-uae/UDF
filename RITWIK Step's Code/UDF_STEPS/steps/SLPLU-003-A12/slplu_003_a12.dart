...
class Slplu003A12ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Slplu003A12ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Slplu003A12ValidationResult({
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Slplu003A12ConformanceLevel.complete:    return 'Complete';
      case Slplu003A12ConformanceLevel.partial:     return 'Partial';
      case Slplu003A12ConformanceLevel.notComplete: return 'Not Complete';
    }
  }
}
...
class Slplu003A12Pipeline {
  ...
  static Slplu003A12Config _ec1Execute(Slplu003A12Config config) {
    if (config.tokenName.isEmpty) {
      throw ArgumentError(
          'EC-SLPLU003A12-001: tokenName required for SLPLU-003-A12');
    }
  ...
  static Slplu003A12Config _ec2Execute(Slplu003A12Config config) {
    if (config.tokenName.isEmpty) {
      throw ArgumentError(
          'EC-SLPLU003A12-002: tokenName required for SLPLU-003-A12');
    }
  ...
  static Slplu003A12Config _ec3Execute(Slplu003A12Config config) {
    if (config.tokenName.isEmpty) {
      throw ArgumentError(
          'EC-SLPLU003A12-003: tokenName required for SLPLU-003-A12');
    }
  ...
  static Slplu003A12Config _ec4Execute(Slplu003A12Config config) {
    if (config.tokenName.isEmpty) {
      throw ArgumentError(
          'EC-SLPLU003A12-004: tokenName required for SLPLU-003-A12');
    }
  ...
  static Slplu003A12ValidationResult calculateConformance({
    ...
    final level      = rate >= _optimal
        ...
        : rate >= _floor
            ...
            : Slplu003A12ConformanceLevel.notComplete;
  ...
  static Slplu003A12Config routeToRegistry(
    Slplu003A12Config config,
    Slplu003A12ValidationResult result,
  ) {
...
class Slplu003A12Widget extends StatelessWidget {
  final List<Slplu003A12Config> configs;
  const Slplu003A12Widget({super.key, required this.configs});
