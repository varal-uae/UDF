...
// Data requirement: Configure the meta viewport tag to lock user-scalable zooming (user-scalable=no).
// ============================================================
...
enum Rcgla012A06ExecutionStatus {
  pending,
  running,
  complete,
  failed,
...
/// Configuration record for RCGLA-012-A06.
...
class Rcgla012A06ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Rcgla012A06ConformanceLevel.complete:    return 'Complete';
      case Rcgla012A06ConformanceLevel.partial:     return 'Partial';
      case Rcgla012A06ConformanceLevel.notComplete: return 'Not Complete';
    }
  }
}
...
class Rcgla012A06Pipeline {
  ...
  static Rcgla012A06ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return const Rcgla012A06ValidationResult(
        totalRecords: 0, conformantRecords: 0, violationCount: 0,
        conformanceRate: 0.0,
        conformanceLevel: Rcgla012A06ConformanceLevel.notComplete,
        gatePass: false,
    ...
    final level      = rate >= _optimal
        ? Rcgla012A06ConformanceLevel.complete
        : rate >= _floor
            ? Rcgla012A06ConformanceLevel.partial
            : Rcgla012A06ConformanceLevel.notComplete;
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      return {'error': 'EC-RCGLA012A06-001: empty config list', 'dlq': true};
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      return {'error': 'EC-RCGLA012A06-TRI: triangular check failed', 'dlq': true};
    }
...
void main() async {
  final configs = [
    Rcgla012A06Config(
      ...
      gridColumns: 'rcgla-012-a06_gridColumns_value',
      gutterSizePx: 'rcgla-012-a06_gutterSizePx_value',
      maxWidthPx: 'rcgla-012-a06_maxWidthPx_value',
      breakpointLabel: 'rcgla-012-a06_breakpointLabel_value',
  ...
  final result = await Rcgla012A06Pipeline.run(
    configs: configs, userId: 'ritwik-udf');
  print('RCGLA-012-A06 → $result');
}
