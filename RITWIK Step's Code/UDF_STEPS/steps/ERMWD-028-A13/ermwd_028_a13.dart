...
class Ermwd028A13ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Ermwd028A13ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Ermwd028A13ValidationResult({
...
class Ermwd028A13Pipeline {
  ...
  static Ermwd028A13Config _ec1Locates(Ermwd028A13Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-ERMWD028A13-001: ruleKey required for ERMWD-028-A13');
    }
    // the ERMWD-028-A13 configuration in the source repository
    return config;
  }

  // EC:2 — System extracts ruleKey and ruleValue from the ERMWD-028-A13 registry.
  static Ermwd028A13Config _ec2Extracts(Ermwd028A13Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-ERMWD028A13-002: ruleKey required for ERMWD-028-A13');
    }
    // ruleKey and ruleValue from the ERMWD-028-A13 registry
    return config;
  }
  ...
  static Ermwd028A13Config _ec4Validates(Ermwd028A13Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-ERMWD028A13-004: ruleKey required for ERMWD-028-A13');
    }
  ...
  static Ermwd028A13Config _ec5Registers(Ermwd028A13Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-ERMWD028A13-005: ruleKey required for ERMWD-028-A13');
    }
  ...
  static Ermwd028A13Config _ec7Routes(Ermwd028A13Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-ERMWD028A13-007: ruleKey required for ERMWD-028-A13');
    }
  ...
  static Ermwd028A13Config _ec8Publishes(Ermwd028A13Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-ERMWD028A13-008: ruleKey required for ERMWD-028-A13');
    }
  ...
  static Ermwd028A13ValidationResult calculateConformance({
    ...
    return Ermwd028A13ValidationResult(
      ...
      ecLineRef:         'EC-ERMWD028A13-VAL',
    );
  }

  static Ermwd028A13Config routeToRegistry(
    Ermwd028A13Config config,
    Ermwd028A13ValidationResult result,
  ) {
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-ERMWD028A13-000: configs must not be empty for ERMWD-028-A13');
    }
    ...
    if (!triangularCheck(configs.length, p8.length)) {
      throw ArgumentError('EC-ERMWD028A13-TRI: triangular check failed for ERMWD-028-A13');
    }
...
class Ermwd028A13Widget extends StatelessWidget {
  final List<Ermwd028A13Config> configs;
  const Ermwd028A13Widget({super.key, required this.configs});
...
void main() async {
  final configs = [
    Ermwd028A13Config(
      configId: 'ermwd028a13-cfg-001',
      ruleKey: 'ermwd-028-a13_ruleKey',
      ruleValue: 'ermwd-028-a13_ruleValue',
      metricLabel: 'ermwd-028-a13_metricLabel',
      complianceTarget: 'ermwd-028-a13_complianceTarget',
      traceId:                 'trace-ermwd028a13-001',
      originSourceId:          'origin-ermwd028a13',
      immediatePredecessorId:  'pred-ermwd028a13-001',
