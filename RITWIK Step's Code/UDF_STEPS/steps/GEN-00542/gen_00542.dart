...
// Description: Extract app_instance_id from the Firebase SDK (mobile client).
...
// Date:        24-Sep-2026
// Source file: GEN-00542_app_instance_id.py
// ============================================================
...
// EC error codes: EC-GEN00542-001 through EC-GEN00542-UTL
...
/// The original Python source for GEN-00542.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00542Executor.run()].
const String kGen00542SourceScript = r'''
...
class Gen00542Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00542-001: traceId required for GEN-00542');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00542-002: originSourceId required for GEN-00542');
    }
    return {
      'step_id':                  'GEN-00542',
      'source_language':          'Python',
      'source_script':            kGen00542SourceScript,
...
void main() {
  final executor = Gen00542Executor(
  ...
  print('GEN-00542 manifest ready:');
