...
enum Nskfi003A04ExecutionStatus { pending, running, complete, failed }
...
class Nskfi003A04Pipeline {
  ...
  static Nskfi003A04Config _ec1Execute(Nskfi003A04Config config) {
    if (config.componentId.isEmpty) {
      throw ArgumentError(
          'EC-NSKFI003A04-001: componentId required for NSKFI-003-A04');
    }
  ...
  static Nskfi003A04Config _ec2Execute(Nskfi003A04Config config) {
    if (config.componentId.isEmpty) {
      throw ArgumentError(
          'EC-NSKFI003A04-002: componentId required for NSKFI-003-A04');
    }
  ...
  static Nskfi003A04Config _ec3Execute(Nskfi003A04Config config) {
    if (config.componentId.isEmpty) {
      throw ArgumentError(
          'EC-NSKFI003A04-003: componentId required for NSKFI-003-A04');
    }
  ...
  static Nskfi003A04Config _ec4Execute(Nskfi003A04Config config) {
    if (config.componentId.isEmpty) {
      throw ArgumentError(
          'EC-NSKFI003A04-004: componentId required for NSKFI-003-A04');
    }
  ...
  static Nskfi003A04ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Nskfi003A04ValidationResult(
        ...
        gatePass: false, ecLineRef: 'EC-NSKFI003A04-VAL',
      );
    }
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-NSKFI003A04-000: configs must not be empty for NSKFI-003-A04');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-NSKFI003A04-TRI: triangular check failed for NSKFI-003-A04');
    }
...
void main() async {
  final configs = [
    Nskfi003A04Config(
      ...
      componentId: 'nskfi-003-a04_componentId',
      targetSizeDp: 'nskfi-003-a04_targetSizeDp',
      actualSizeDp: 'nskfi-003-a04_actualSizeDp',
      complianceStatus: 'nskfi-003-a04_complianceStatus',
  ...
  final out = await Nskfi003A04Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('NSKFI-003-A04 [Complete / Partial / Not Complete] → $out');
}
