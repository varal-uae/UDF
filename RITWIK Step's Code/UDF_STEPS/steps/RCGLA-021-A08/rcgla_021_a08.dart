...
enum Rcgla021A08ExecutionStatus { pending, running, complete, failed }
...
void main() async {
  ...
  final out = await Rcgla021A08Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('RCGLA-021-A08 [Complete / Partial / Not Complete] → $out');
}
