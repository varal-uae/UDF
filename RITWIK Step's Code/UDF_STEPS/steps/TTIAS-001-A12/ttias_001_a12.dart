...
class Ttias001A12ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Ttias001A12ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Ttias001A12ValidationResult({
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Ttias001A12ConformanceLevel.complete:    return 'Complete';
      case Ttias001A12ConformanceLevel.partial:     return 'Partial';
      case Ttias001A12ConformanceLevel.notComplete: return 'Not Complete';
    }
  }
}
...
class Ttias001A12Pipeline {
  ...
  static Ttias001A12ValidationResult calculateConformance({
    ...
    final level = rate >= _optimal
        ...
        : rate >= _floor
            ...
            : Ttias001A12ConformanceLevel.notComplete;
    return Ttias001A12ValidationResult(
  ...
  static Ttias001A12Config routeToRegistry(
    Ttias001A12Config config,
    Ttias001A12ValidationResult result,
  ) {
...
class Ttias001A12Widget extends StatelessWidget {
  final List<Ttias001A12Config> configs;
  const Ttias001A12Widget({super.key, required this.configs});
