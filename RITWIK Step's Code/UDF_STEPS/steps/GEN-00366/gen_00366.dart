...
// Description: JSON utility step for GEN-00366
...
// Date:        24-Sep-2026
// Source file: GEN-00366_firebase_hosting.json
// ============================================================
...
// EC error codes: EC-GEN00366-001 through EC-GEN00366-UTL
...
/// The original JSON source for GEN-00366.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00366Executor.run()].
const String kGen00366SourceScript = r'''
{
  "//": "GEN-00366 — deploy mobile frontend bundle to Firebase Hosting CDN.",
...
class Gen00366Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00366-001: traceId required for GEN-00366');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00366-002: originSourceId required for GEN-00366');
    }
    return {
      'step_id':                  'GEN-00366',
      'source_language':          'JSON',
      'source_script':            kGen00366SourceScript,
...
void main() {
  final executor = Gen00366Executor(
  ...
  print('GEN-00366 manifest ready:');
