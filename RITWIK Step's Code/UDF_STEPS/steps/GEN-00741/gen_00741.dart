...
// Description: automated clawback report generation on fraud spikes.
...
// Date:        24-Sep-2026
// Source file: GEN-00741_clawback_report.py
// ============================================================
...
// EC error codes: EC-GEN00741-001 through EC-GEN00741-UTL
...
/// The original Python source for GEN-00741.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00741Executor.run()].
const String kGen00741SourceScript = r'''
...
class Gen00741Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00741-001: traceId required for GEN-00741');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00741-002: originSourceId required for GEN-00741');
    }
    return {
      'step_id':                  'GEN-00741',
      'source_language':          'Python',
      'source_script':            kGen00741SourceScript,
...
void main() {
  final executor = Gen00741Executor(
  ...
  print('GEN-00741 manifest ready:');
