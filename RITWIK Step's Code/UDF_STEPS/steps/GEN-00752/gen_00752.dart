...
// Description: SQL utility step for GEN-00752
...
// Date:        24-Sep-2026
// Source file: GEN-00752_cohort_retention_summary.sql
// ============================================================
...
// EC error codes: EC-GEN00752-001 through EC-GEN00752-UTL
...
/// The original SQL source for GEN-00752.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00752Executor.run()].
const String kGen00752SourceScript = r'''
...
class Gen00752Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00752-001: traceId required for GEN-00752');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00752-002: originSourceId required for GEN-00752');
    }
    return {
      'step_id':                  'GEN-00752',
      'source_language':          'SQL',
      'source_script':            kGen00752SourceScript,
...
void main() {
  final executor = Gen00752Executor(
  ...
  print('GEN-00752 manifest ready:');
