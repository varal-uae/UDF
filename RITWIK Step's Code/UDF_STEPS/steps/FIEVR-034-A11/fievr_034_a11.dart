...
enum Fievr034A11ConformanceLevel {
  pass_,   // ≥ floor
  fail_,   // < floor
}
...
class Fievr034A11ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Fievr034A11ConformanceLevel.pass_: return 'Pass';
      case Fievr034A11ConformanceLevel.fail_: return 'Fail';
    }
  }
}
  ...
  static Fievr034A11ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Fievr034A11ValidationResult(
        ...
        conformanceRate: 0.0,
        conformanceLevel: Fievr034A11ConformanceLevel.fail_,
    ...
    final level = rate >= _floor
        ? Fievr034A11ConformanceLevel.pass_
        : Fievr034A11ConformanceLevel.fail_;
    return Fievr034A11ValidationResult(
...
Map<String, dynamic> fievr_034_a11Dlq(
...
void main() async {
  ...
  final out = await Fievr034A11Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('FIEVR-034-A11 [Pass / Fail] → $out');
}
