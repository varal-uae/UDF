...
// Metric:       Validation / Test Pass Rate - Typed keystroke character hardcoded allo
...
enum Is03Csivw007As01A07ConformanceLevel {
  complete,    // ≥ optimal
  partial,     // ≥ floor
  notComplete, // < floor
}
...
class Is03Csivw007As01A07ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Is03Csivw007As01A07ConformanceLevel.complete:    return 'Complete';
      case Is03Csivw007As01A07ConformanceLevel.partial:     return 'Partial';
      case Is03Csivw007As01A07ConformanceLevel.notComplete: return 'Not Complete';
    }
  }
}
...
class Is03Csivw007As01A07Pipeline {
  ...
  static Future<Map<String, dynamic>> run({
    ...
    return {
      ...
      'metric':             'Validation / Test Pass Rate - Typed keystroke character hard',
...
Map<String, dynamic> is03_csivw_007_as01_a07Dlq(
...
void main() async {
  ...
  final out = await Is03Csivw007As01A07Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('IS03-CSIVW-007-AS01-A07 [Complete / Partial / Not Complete] → $out');
}
