...
// Why this matters: 
// Mobile impl:      
// Data requirement: Design the radial gauge chart layout.
// ============================================================
...
enum HcIam0126ConformanceLevel { complete, partial, notComplete }
enum HcIam0126ExecutionStatus  { pending, running, complete, failed }

// ── Data Model ───────────────────────────────────────────────

/// Configuration record for HC-IAM-0126.
...
class HcIam0126ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case HcIam0126ConformanceLevel.complete:    return 'Good';
      case HcIam0126ConformanceLevel.partial:     return 'Average';
      case HcIam0126ConformanceLevel.notComplete: return 'Poor';
    }
  }
}
...
class HcIam0126Pipeline {
  ...
  static HcIam0126ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return const HcIam0126ValidationResult(
    ...
    final level      = rate >= _optimal
        ? HcIam0126ConformanceLevel.complete
        : rate >= _floor
            ? HcIam0126ConformanceLevel.partial
            : HcIam0126ConformanceLevel.notComplete;
...
Map<String, dynamic> hc_iam_0126Dlq(String errorCode, Map<String, dynamic> payload) => {
...
void main() async {
  ...
  final result = await HcIam0126Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('HC-IAM-0126 → $result');
}
