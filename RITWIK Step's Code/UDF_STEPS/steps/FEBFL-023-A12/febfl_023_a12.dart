...
enum Febfl023A12ConformanceLevel {
  complete,    // ≥ optimal
  partial,     // ≥ floor
  notComplete, // < floor
}
...
Map<String, dynamic> febfl_023_a12Dlq(
...
void main() async {
  ...
  final out = await Febfl023A12Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('FEBFL-023-A12 [Complete / Partial / Not Complete] → $out');
}
