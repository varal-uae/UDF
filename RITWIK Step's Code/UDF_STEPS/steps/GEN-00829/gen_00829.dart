...
// Description: @clock_monitor decorator for backend microservice functions.
...
// Date:        24-Sep-2026
// Source file: GEN-00829_clock_monitor.py
// ============================================================
...
// EC error codes: EC-GEN00829-001 through EC-GEN00829-UTL
...
/// The original Python source for GEN-00829.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00829Executor.run()].
const String kGen00829SourceScript = r'''
...
class Gen00829Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00829-001: traceId required for GEN-00829');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00829-002: originSourceId required for GEN-00829');
    }
    return {
      'step_id':                  'GEN-00829',
      'source_language':          'Python',
      'source_script':            kGen00829SourceScript,
...
void main() {
  final executor = Gen00829Executor(
  ...
  print('GEN-00829 manifest ready:');
