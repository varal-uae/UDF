...
// Description: backup_currency_monitor.py.
...
// Date:        24-Sep-2026
// Source file: GEN-00476_backup_currency_monitor.py
// ============================================================
...
// EC error codes: EC-GEN00476-001 through EC-GEN00476-UTL
...
/// The original Python source for GEN-00476.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00476Executor.run()].
const String kGen00476SourceScript = r'''
...
class Gen00476Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00476-001: traceId required for GEN-00476');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00476-002: originSourceId required for GEN-00476');
    }
    return {
      'step_id':                  'GEN-00476',
      'source_language':          'Python',
      'source_script':            kGen00476SourceScript,
...
void main() {
  final executor = Gen00476Executor(
  ...
  print('GEN-00476 manifest ready:');
