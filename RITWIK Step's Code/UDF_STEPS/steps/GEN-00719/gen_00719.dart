...
// Description: JSON utility step for GEN-00719
...
// Date:        24-Sep-2026
// Source file: GEN-00719_reward_unlocked_schema.json
// ============================================================
...
// EC error codes: EC-GEN00719-001 through EC-GEN00719-UTL
...
/// The original JSON source for GEN-00719.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00719Executor.run()].
const String kGen00719SourceScript = r'''
{
  "//": "GEN-00719 — event schema reward_unlocked.",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "reward_unlocked",
  "type": "object",
  "required": ["user_id", "reward_id", "unlocked_at"],
  "properties": {
    "user_id": { "type": "string" },
...
class Gen00719Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00719-001: traceId required for GEN-00719');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00719-002: originSourceId required for GEN-00719');
    }
    return {
      'step_id':                  'GEN-00719',
      'source_language':          'JSON',
      'source_script':            kGen00719SourceScript,
...
void main() {
  final executor = Gen00719Executor(
  ...
  print('GEN-00719 manifest ready:');
