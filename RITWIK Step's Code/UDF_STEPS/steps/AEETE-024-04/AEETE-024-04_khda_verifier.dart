...
class DcdfLineage {
  ...
  static void _validateNotEmpty(String value, String fieldName) {
    if (value.isEmpty) {
      throw ArgumentError('EC-AEETE02404-000: $fieldName must not be empty for AEETE-024-04');
    }
  }
}
...
class KHDAVerifier {
  ...
  // -------------------------------------------------------------------------
  // EC:3 — Scan layout content for all 4 rule types.  // error: EC-AEETE02404-001
  // -------------------------------------------------------------------------
  KHDAScanResult scan(String layoutId, Map<String, String> content) {
    ...
    // EC:7 — Calculate adherence rate  // error: EC-AEETE02404-002
  ...
  // -------------------------------------------------------------------------
  // EC:6 — Batch scan multiple layouts.  // error: EC-AEETE02404-003
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // EC:7 — Overall adherence rate across a batch.  // error: EC-AEETE02404-004
  // -------------------------------------------------------------------------
