...
// Data requirement: Set the strict pixel dimension rule for the gutters separating the columns.
// ============================================================
...
enum Sctss002A04ExecutionStatus {
  pending,
  running,
  complete,
  failed,
...
/// Configuration record for SCTSS-002-A04.
...
class Sctss002A04ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Sctss002A04ConformanceLevel.complete:    return 'Complete';
      case Sctss002A04ConformanceLevel.partial:     return 'Partial';
      case Sctss002A04ConformanceLevel.notComplete: return 'Not Complete';
    }
  }
}
...
class Sctss002A04Pipeline {
  ...
  static Sctss002A04ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return const Sctss002A04ValidationResult(
    ...
    final level      = rate >= _optimal
        ? Sctss002A04ConformanceLevel.complete
        : rate >= _floor
            ? Sctss002A04ConformanceLevel.partial
            : Sctss002A04ConformanceLevel.notComplete;
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      return {'error': 'EC-SCTSS002A04-001: empty config list', 'dlq': true};
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      return {'error': 'EC-SCTSS002A04-TRI: triangular check failed', 'dlq': true};
    }
...
void main() async {
  final configs = [
    Sctss002A04Config(
      ...
      gridColumns: 'sctss-002-a04_gridColumns_value',
      gutterSizePx: 'sctss-002-a04_gutterSizePx_value',
      maxWidthPx: 'sctss-002-a04_maxWidthPx_value',
      breakpointLabel: 'sctss-002-a04_breakpointLabel_value',
  ...
  final result = await Sctss002A04Pipeline.run(
    configs: configs, userId: 'ritwik-udf');
  print('SCTSS-002-A04 → $result');
}
