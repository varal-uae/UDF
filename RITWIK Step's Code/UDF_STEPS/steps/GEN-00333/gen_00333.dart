...
// Description: Confirm Steps 15, 21, and 40 are complete as prerequisites
...
// Date:        24-Sep-2026
// Source file: GEN-00333_confirm_prerequisites.md
// ============================================================
...
// EC error codes: EC-GEN00333-001 through EC-GEN00333-UTL
...
/// The original Markdown source for GEN-00333.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00333Executor.run()].
const String kGen00333SourceScript = r'''
# GEN-00333 — Confirm Steps 15, 21, and 40 are complete as prerequisites
Metric: Predecessor Dependency Verification · Pass/Fail
...
## Action
Verify Steps 15, 21, 40 show a completed status before this step proceeds. PASS only if all three predecessors are complete.
''';
...
class Gen00333Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00333-001: traceId required for GEN-00333');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00333-002: originSourceId required for GEN-00333');
    }
    return {
      'step_id':                  'GEN-00333',
      'source_language':          'Markdown',
      'source_script':            kGen00333SourceScript,
...
void main() {
  final executor = Gen00333Executor(
  ...
  print('GEN-00333 manifest ready:');
