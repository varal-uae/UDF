...
enum Rcgla021A05ExecutionStatus { pending, running, complete, failed }
...
void main() async {
  ...
  final out = await Rcgla021A05Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('RCGLA-021-A05 [Complete / Partial / Not Complete] → $out');
}
