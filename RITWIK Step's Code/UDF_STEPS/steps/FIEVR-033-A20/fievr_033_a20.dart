...
class Fievr033A20ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Fievr033A20ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Fievr033A20ValidationResult({
...
class Fievr033A20Pipeline {
  ...
  static Fievr033A20Config _ec1Execute(Fievr033A20Config config) {
    if (config.fieldId.isEmpty) {
      throw ArgumentError(
          'EC-FIEVR033A20-001: fieldId required for FIEVR-033-A20');
    }
  ...
  static Fievr033A20Config _ec2Execute(Fievr033A20Config config) {
    if (config.fieldId.isEmpty) {
      throw ArgumentError(
          'EC-FIEVR033A20-002: fieldId required for FIEVR-033-A20');
    }
  ...
  static Fievr033A20Config _ec3Execute(Fievr033A20Config config) {
    if (config.fieldId.isEmpty) {
      throw ArgumentError(
          'EC-FIEVR033A20-003: fieldId required for FIEVR-033-A20');
    }
  ...
  static Fievr033A20Config _ec4Execute(Fievr033A20Config config) {
    if (config.fieldId.isEmpty) {
      throw ArgumentError(
          'EC-FIEVR033A20-004: fieldId required for FIEVR-033-A20');
    }
  ...
  static Fievr033A20ValidationResult calculateConformance({
    ...
    return Fievr033A20ValidationResult(
      ...
      ecLineRef:         'EC-FIEVR033A20-VAL',
    );
  }

  static Fievr033A20Config routeToRegistry(
    Fievr033A20Config config,
    Fievr033A20ValidationResult result,
  ) {
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-FIEVR033A20-000: configs must not be empty for FIEVR-033-A20');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-FIEVR033A20-TRI: triangular check failed for FIEVR-033-A20');
    }
...
class Fievr033A20Widget extends StatelessWidget {
  final List<Fievr033A20Config> configs;
  const Fievr033A20Widget({super.key, required this.configs});
...
void main() async {
  final configs = [
    Fievr033A20Config(
      configId: 'fievr033a20-cfg-001',
      fieldId: 'fievr-033-a20_fieldId',
      validationRule: 'fievr-033-a20_validationRule',
      errorMessage: 'fievr-033-a20_errorMessage',
      inputType: 'fievr-033-a20_inputType',
      traceId:                 'trace-fievr033a20-001',
      originSourceId:          'origin-fievr033a20',
      immediatePredecessorId:  'pred-fievr033a20-001',
