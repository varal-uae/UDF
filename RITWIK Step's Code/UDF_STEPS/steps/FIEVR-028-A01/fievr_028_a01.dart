...
enum Fievr028A01ExecutionStatus { pending, running, complete, failed }
...
class Fievr028A01ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Fievr028A01ConformanceLevel.pass_: return 'Pass';
      case Fievr028A01ConformanceLevel.fail_: return 'Fail';
    }
  }
}
  ...
  static Fievr028A01ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Fievr028A01ValidationResult(
        ...
        conformanceRate: 0.0,
        conformanceLevel: Fievr028A01ConformanceLevel.fail_,
    ...
    final level = rate >= _floor
        ? Fievr028A01ConformanceLevel.pass_
        : Fievr028A01ConformanceLevel.fail_;
    return Fievr028A01ValidationResult(
...
void main() async {
  ...
  final out = await Fievr028A01Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('FIEVR-028-A01 [Pass / Fail] → $out');
}
