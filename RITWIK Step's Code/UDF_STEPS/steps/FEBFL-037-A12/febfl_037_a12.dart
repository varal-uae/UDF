...
// Metric:       Build/Commit Integrity Rate (%) - modal templates and confirmation com
...
enum Febfl037A12ConformanceLevel {
  pass_,   // ≥ floor
  fail_,   // < floor
}
...
class Febfl037A12ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Febfl037A12ConformanceLevel.pass_: return 'Pass';
      case Febfl037A12ConformanceLevel.fail_: return 'Fail';
    }
  }
}
...
/// Metric: Build/Commit Integrity Rate (%) - modal templates and confir
  ...
  static Febfl037A12ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Febfl037A12ValidationResult(
        ...
        conformanceRate: 0.0,
        conformanceLevel: Febfl037A12ConformanceLevel.fail_,
    ...
    final level = rate >= _floor
        ? Febfl037A12ConformanceLevel.pass_
        : Febfl037A12ConformanceLevel.fail_;
    return Febfl037A12ValidationResult(
...
Map<String, dynamic> febfl_037_a12Dlq(
...
void main() async {
  ...
  final out = await Febfl037A12Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('FEBFL-037-A12 [Pass / Fail] → $out');
}
