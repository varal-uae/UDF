...
enum Fievr034A13ConformanceLevel {
  pass_,   // ≥ floor
  fail_,   // < floor
}
...
class Fievr034A13ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Fievr034A13ConformanceLevel.pass_: return 'Pass';
      case Fievr034A13ConformanceLevel.fail_: return 'Fail';
    }
  }
}
  ...
  static Fievr034A13ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Fievr034A13ValidationResult(
        ...
        conformanceRate: 0.0,
        conformanceLevel: Fievr034A13ConformanceLevel.fail_,
    ...
    final level = rate >= _floor
        ? Fievr034A13ConformanceLevel.pass_
        : Fievr034A13ConformanceLevel.fail_;
    return Fievr034A13ValidationResult(
...
Map<String, dynamic> fievr_034_a13Dlq(
...
void main() async {
  ...
  final out = await Fievr034A13Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('FIEVR-034-A13 [Pass / Fail] → $out');
}
