...
class Is41Slplu016As01A01Config {
  ...
  const Is41Slplu016As01A01Config({
  ...
  Is41Slplu016As01A01Config copyWith({
    String? validationStatus,
    bool?   immutableInd,
    bool?   complianceStatusInd,
  }) => Is41Slplu016As01A01Config(
    configId: configId,
...
class Is41Slplu016As01A01ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Is41Slplu016As01A01ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Is41Slplu016As01A01ValidationResult({
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Is41Slplu016As01A01ConformanceLevel.complete:    return 'Complete';
      case Is41Slplu016As01A01ConformanceLevel.partial:     return 'Partial';
      case Is41Slplu016As01A01ConformanceLevel.notComplete: return 'Not Complete';
    }
  }
}
...
class Is41Slplu016As01A01Pipeline {
  ...
  static Is41Slplu016As01A01Config _ec1Execute(Is41Slplu016As01A01Config config) {
    if (config.colorToken.isEmpty) {
      throw ArgumentError(
          'EC-IS41SLPLU016-001: colorToken required for IS41-SLPLU-016-AS01-A01');
    }
  ...
  static Is41Slplu016As01A01Config _ec2Execute(Is41Slplu016As01A01Config config) {
    if (config.colorToken.isEmpty) {
      throw ArgumentError(
          'EC-IS41SLPLU016-002: colorToken required for IS41-SLPLU-016-AS01-A01');
    }
  ...
  static Is41Slplu016As01A01Config _ec3Execute(Is41Slplu016As01A01Config config) {
    if (config.colorToken.isEmpty) {
      throw ArgumentError(
          'EC-IS41SLPLU016-003: colorToken required for IS41-SLPLU-016-AS01-A01');
    }
  ...
  static Is41Slplu016As01A01Config _ec4Execute(Is41Slplu016As01A01Config config) {
    if (config.colorToken.isEmpty) {
      throw ArgumentError(
          'EC-IS41SLPLU016-004: colorToken required for IS41-SLPLU-016-AS01-A01');
    }
  ...
  static Is41Slplu016As01A01ValidationResult calculateConformance({
    ...
    final level = rate >= _optimal
        ...
        : rate >= _floor
            ...
            : Is41Slplu016As01A01ConformanceLevel.notComplete;
    return Is41Slplu016As01A01ValidationResult(
  ...
  static Is41Slplu016As01A01Config routeToRegistry(
    Is41Slplu016As01A01Config config,
    Is41Slplu016As01A01ValidationResult result,
  ) {
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-IS41SLPLU016-000: configs must not be empty for IS41-SLPLU-016-AS01-A01');
    }
...
Map<String, dynamic> is41_slplu_016_as01_a01Dlq(
  ...
  'dlq':               true,
  'step_ref':          'IS41-SLPLU-016-AS01-A01',
...
class Is41Slplu016As01A01Widget extends StatelessWidget {
  final List<Is41Slplu016As01A01Config> configs;
  const Is41Slplu016As01A01Widget({super.key, required this.configs});
...
void main() async {
  final configs = [
    Is41Slplu016As01A01Config(
      ...
      colorToken: 'is41-slplu-016-as01-a01_colorToken',
      hexValue: 'is41-slplu-016-as01-a01_hexValue',
      wcagRatio: 'is41-slplu-016-as01-a01_wcagRatio',
      usageContext: 'is41-slplu-016-as01-a01_usageContext',
