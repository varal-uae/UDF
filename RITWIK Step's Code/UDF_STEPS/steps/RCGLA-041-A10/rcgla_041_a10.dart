...
enum Rcgla041A10ExecutionStatus { pending, running, complete, failed }
...
void main() async {
  ...
  final out = await Rcgla041A10Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('RCGLA-041-A10 [Complete / Partial / Not Complete] → $out');
}
