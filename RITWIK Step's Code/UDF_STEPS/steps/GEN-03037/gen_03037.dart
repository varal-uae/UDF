...
class Gen03037ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Gen03037ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Gen03037ValidationResult({
...
class Gen03037Pipeline {
  ...
  static Gen03037Config _ec1Execute(Gen03037Config config) {
    if (config.eventId.isEmpty) {
      throw ArgumentError(
          'EC-GEN03037-001: eventId required for GEN-03037');
    }
  ...
  static Gen03037Config _ec2Execute(Gen03037Config config) {
    if (config.eventId.isEmpty) {
      throw ArgumentError(
          'EC-GEN03037-002: eventId required for GEN-03037');
    }
  ...
  static Gen03037Config _ec3Execute(Gen03037Config config) {
    if (config.eventId.isEmpty) {
      throw ArgumentError(
          'EC-GEN03037-003: eventId required for GEN-03037');
    }
  ...
  static Gen03037Config _ec4Execute(Gen03037Config config) {
    if (config.eventId.isEmpty) {
      throw ArgumentError(
          'EC-GEN03037-004: eventId required for GEN-03037');
    }
  ...
  static Gen03037ValidationResult calculateConformance({
    ...
    return Gen03037ValidationResult(
      ...
      ecLineRef:         'EC-GEN03037-VAL',
    );
  }

  static Gen03037Config routeToRegistry(
    Gen03037Config config,
    Gen03037ValidationResult result,
  ) {
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-GEN03037-000: configs must not be empty for GEN-03037');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-GEN03037-TRI: triangular check failed for GEN-03037');
    }
...
class Gen03037Widget extends StatelessWidget {
  final List<Gen03037Config> configs;
  const Gen03037Widget({super.key, required this.configs});
...
void main() async {
  final configs = [
    Gen03037Config(
      configId: 'gen03037-cfg-001',
      eventId: 'gen-03037_eventId',
      sessionId: 'gen-03037_sessionId',
      frictionType: 'gen-03037_frictionType',
      resolutionMs: 'gen-03037_resolutionMs',
      traceId:                 'trace-gen03037-001',
      originSourceId:          'origin-gen03037',
      immediatePredecessorId:  'pred-gen03037-001',
