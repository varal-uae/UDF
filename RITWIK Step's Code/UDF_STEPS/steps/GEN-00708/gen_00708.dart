...
// Description: SQL utility step for GEN-00708
...
// Date:        24-Sep-2026
// Source file: GEN-00708_lineage_error_scan.sql
// ============================================================
...
// EC error codes: EC-GEN00708-001 through EC-GEN00708-UTL
...
/// The original SQL source for GEN-00708.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00708Executor.run()].
const String kGen00708SourceScript = r'''
...
class Gen00708Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00708-001: traceId required for GEN-00708');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00708-002: originSourceId required for GEN-00708');
    }
    return {
      'step_id':                  'GEN-00708',
      'source_language':          'SQL',
      'source_script':            kGen00708SourceScript,
...
void main() {
  final executor = Gen00708Executor(
  ...
  print('GEN-00708 manifest ready:');
