...
class Rcgla002A02ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Rcgla002A02ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Rcgla002A02ValidationResult({
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Rcgla002A02ConformanceLevel.complete:    return 'Complete';
      case Rcgla002A02ConformanceLevel.partial:     return 'Partial';
      case Rcgla002A02ConformanceLevel.notComplete: return 'Not Complete';
    }
  }
}
...
class Rcgla002A02Pipeline {
  ...
  static Rcgla002A02ValidationResult calculateConformance({
    ...
    final level = rate >= _optimal
        ...
        : rate >= _floor
            ...
            : Rcgla002A02ConformanceLevel.notComplete;
    return Rcgla002A02ValidationResult(
  ...
  static Rcgla002A02Config routeToRegistry(
    Rcgla002A02Config config,
    Rcgla002A02ValidationResult result,
  ) {
...
class Rcgla002A02Widget extends StatelessWidget {
  final List<Rcgla002A02Config> configs;
  const Rcgla002A02Widget({super.key, required this.configs});
