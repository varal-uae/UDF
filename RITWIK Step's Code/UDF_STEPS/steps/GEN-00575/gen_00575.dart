...
// Description: HeaderInjectionMiddleware, registered globally in Django settings.
...
// Date:        24-Sep-2026
// Source file: GEN-00575_header_injection_middleware.py
// ============================================================
...
// EC error codes: EC-GEN00575-001 through EC-GEN00575-UTL
...
/// The original Python source for GEN-00575.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00575Executor.run()].
const String kGen00575SourceScript = r'''
...
class Gen00575Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00575-001: traceId required for GEN-00575');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00575-002: originSourceId required for GEN-00575');
    }
    return {
      'step_id':                  'GEN-00575',
      'source_language':          'Python',
      'source_script':            kGen00575SourceScript,
...
void main() {
  final executor = Gen00575Executor(
  ...
  print('GEN-00575 manifest ready:');
