...
// Description: Run UI hesitation tests; verify logs reach BigQuery within 5s
...
// Date:        24-Sep-2026
// Source file: GEN-00641_ui_hesitation_bq_verify.md
// ============================================================
...
// EC error codes: EC-GEN00641-001 through EC-GEN00641-UTL
...
/// The original Markdown source for GEN-00641.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00641Executor.run()].
const String kGen00641SourceScript = r'''
# GEN-00641 — Run UI hesitation tests; verify logs reach BigQuery within 5s
Metric: Telemetry Ingestion Delay · Pass/Fail

**Operational / verification step — not a source file.** Recorded for traceability.

## Action
Execute the mobile-form hesitation test suite; confirm hesitation-event rows appear in the target BigQuery table within 5 seconds of capture.
''';
...
class Gen00641Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00641-001: traceId required for GEN-00641');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00641-002: originSourceId required for GEN-00641');
    }
    return {
      'step_id':                  'GEN-00641',
      'source_language':          'Markdown',
      'source_script':            kGen00641SourceScript,
...
void main() {
  final executor = Gen00641Executor(
  ...
  print('GEN-00641 manifest ready:');
