...
enum Slplu003A04ExecutionStatus { pending, running, complete, failed }
...
class Slplu003A04Pipeline {
  ...
  static Slplu003A04ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Slplu003A04ValidationResult(
        ...
        gatePass: false, ecLineRef: 'EC-SLPLU003A04-VAL',
      );
    }
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-SLPLU003A04-000: configs must not be empty for SLPLU-003-A04');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-SLPLU003A04-TRI: triangular check failed for SLPLU-003-A04');
    }
...
void main() async {
  final configs = [
    Slplu003A04Config(
      ...
      colorToken: 'slplu-003-a04_colorToken',
      hexValue: 'slplu-003-a04_hexValue',
      wcagRatio: 'slplu-003-a04_wcagRatio',
      usageContext: 'slplu-003-a04_usageContext',
  ...
  final out = await Slplu003A04Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('SLPLU-003-A04 [Complete / Partial / Not Complete] → $out');
}
