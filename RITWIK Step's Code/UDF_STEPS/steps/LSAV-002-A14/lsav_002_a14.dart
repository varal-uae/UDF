...
// Why this matters: 
// Mobile impl:      
// Data requirement: Execute a load test to verify admin view load times stay below the 1s target.
// ============================================================
...
enum Lsav002A14ConformanceLevel { complete, partial, notComplete }
enum Lsav002A14ExecutionStatus  { pending, running, complete, failed }

// ── Data Model ───────────────────────────────────────────────

/// Configuration record for LSAV-002-A14.
...
class Lsav002A14Pipeline {
  ...
  static Lsav002A14Config _ec1Locates(Lsav002A14Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-LSAV002A14-001: ruleKey required for LSAV-002-A14');
    }
    // the LSAV-002-A14 configuration in the source repository
    return config;
  }

  // EC:2 — System extracts ruleKey and ruleValue from the LSAV-002-A14 registry.
  static Lsav002A14Config _ec2Extracts(Lsav002A14Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-LSAV002A14-002: ruleKey required for LSAV-002-A14');
    }
    // ruleKey and ruleValue from the LSAV-002-A14 registry
    return config;
  }
  ...
  static Lsav002A14Config _ec3Compiles(Lsav002A14Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-LSAV002A14-003: ruleKey required for LSAV-002-A14');
    }
  ...
  static Lsav002A14Config _ec4Validates(Lsav002A14Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-LSAV002A14-004: ruleKey required for LSAV-002-A14');
    }
  ...
  static Lsav002A14Config _ec5Registers(Lsav002A14Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-LSAV002A14-005: ruleKey required for LSAV-002-A14');
    }
  ...
  static Lsav002A14Config _ec6Validates(Lsav002A14Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-LSAV002A14-006: ruleKey required for LSAV-002-A14');
    }
  ...
  static Lsav002A14Config _ec7Routes(Lsav002A14Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-LSAV002A14-007: ruleKey required for LSAV-002-A14');
    }
  ...
  static Lsav002A14Config _ec8Publishes(Lsav002A14Config config) {
    if (config.ruleKey.isEmpty) {
      throw ArgumentError(
          'EC-LSAV002A14-008: ruleKey required for LSAV-002-A14');
    }
  ...
  static Lsav002A14ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return const Lsav002A14ValidationResult(
...
Map<String, dynamic> lsav_002_a14Dlq(String errorCode, Map<String, dynamic> payload) => {
...
void main() async {
  final configs = [
    Lsav002A14Config(
      ...
      ruleKey: 'lsav-002-a14_ruleKey',
      ruleValue: 'lsav-002-a14_ruleValue',
      metricLabel: 'lsav-002-a14_metricLabel',
      complianceTarget: 'lsav-002-a14_complianceTarget',
  ...
  final result = await Lsav002A14Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('LSAV-002-A14 → $result');
}
