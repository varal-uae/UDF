...
enum Rcgla019A06ExecutionStatus { pending, running, complete, failed }
...
void main() async {
  ...
  final out = await Rcgla019A06Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('RCGLA-019-A06 [Complete / Partial / Not Complete] → $out');
}
