...
enum Mufce002A07ConformanceLevel {
  complete,    // ≥ optimal
  partial,     // ≥ floor
  notComplete, // < floor
}
...
Map<String, dynamic> mufce_002_a07Dlq(
...
void main() async {
  ...
  final out = await Mufce002A07Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('MUFCE-002-A07 [Complete / Partial / Not Complete] → $out');
}
