...
enum Fievr033A12ExecutionStatus { pending, running, complete, failed }
...
class Fievr033A12ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Fievr033A12ConformanceLevel.pass_: return 'Pass';
      case Fievr033A12ConformanceLevel.fail_: return 'Fail';
    }
  }
}
  ...
  static Fievr033A12ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Fievr033A12ValidationResult(
        ...
        conformanceRate: 0.0,
        conformanceLevel: Fievr033A12ConformanceLevel.fail_,
    ...
    final level = rate >= _floor
        ? Fievr033A12ConformanceLevel.pass_
        : Fievr033A12ConformanceLevel.fail_;
    return Fievr033A12ValidationResult(
...
void main() async {
  ...
  final out = await Fievr033A12Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('FIEVR-033-A12 [Pass / Fail] → $out');
}
