...
class Gen01934ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Gen01934ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Gen01934ValidationResult({
...
class Gen01934Pipeline {
  ...
  static Gen01934ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Gen01934ValidationResult(
        ...
        gatePass: false, ecLineRef: 'EC-GEN01934-VAL',
      );
    }
    ...
    return Gen01934ValidationResult(
      ...
      ecLineRef:         'EC-GEN01934-VAL',
    );
  }

  static Gen01934Config routeToRegistry(
    Gen01934Config config,
    Gen01934ValidationResult result,
  ) {
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-GEN01934-000: configs must not be empty for GEN-01934');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-GEN01934-TRI: triangular check failed for GEN-01934');
    }
...
class Gen01934Widget extends StatelessWidget {
  final List<Gen01934Config> configs;
  const Gen01934Widget({super.key, required this.configs});
