...
class Awcv001AccessibleWidgetColorValidation {
  ...
  static Map<String, dynamic>? locateConfiguration(String repoPath) {
      ...
      throw ArgumentError('EC-AWCV001-001: repo path must not be empty');
    };
  ...
  static Map<String, dynamic> extractParameters(Map<String, dynamic> config) {
    ...
    if (!(required.every((k) => config.containsKey(k) && config[k] != null))) {
      throw ArgumentError('EC-AWCV001-002: all 5 color rule fields must be non-null',
    );
  ...
  static WidgetColorRuleEntry registerRule(WidgetColorRuleEntry entry) {
        if (!(entry.colorToken.startsWith('md.sys.color'))) {
      throw ArgumentError('EC-AWCV001-003: colorToken must map to md.sys.color token set');
    }
    };
  ...
  static String bindToTarget(String ruleId, String colorToken) {
      ...
      throw ArgumentError('EC-AWCV001-005: FK bind requires valid ruleId');
    };
