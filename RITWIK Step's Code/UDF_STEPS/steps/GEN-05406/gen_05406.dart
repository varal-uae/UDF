...
class Gen05406ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Gen05406ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Gen05406ValidationResult({
...
class Gen05406Pipeline {
  ...
  static Gen05406Config _ec1Execute(Gen05406Config config) {
    if (config.widgetId.isEmpty) {
      throw ArgumentError(
          'EC-GEN05406-001: widgetId required for GEN-05406');
    }
  ...
  static Gen05406Config _ec2Execute(Gen05406Config config) {
    if (config.widgetId.isEmpty) {
      throw ArgumentError(
          'EC-GEN05406-002: widgetId required for GEN-05406');
    }
  ...
  static Gen05406Config _ec3Execute(Gen05406Config config) {
    if (config.widgetId.isEmpty) {
      throw ArgumentError(
          'EC-GEN05406-003: widgetId required for GEN-05406');
    }
  ...
  static Gen05406Config _ec4Execute(Gen05406Config config) {
    if (config.widgetId.isEmpty) {
      throw ArgumentError(
          'EC-GEN05406-004: widgetId required for GEN-05406');
    }
  ...
  static Gen05406ValidationResult calculateConformance({
    ...
    return Gen05406ValidationResult(
      ...
      ecLineRef:         'EC-GEN05406-VAL',
    );
  }

  static Gen05406Config routeToRegistry(
    Gen05406Config config,
    Gen05406ValidationResult result,
  ) {
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-GEN05406-000: configs must not be empty for GEN-05406');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-GEN05406-TRI: triangular check failed for GEN-05406');
    }
...
class Gen05406Widget extends StatelessWidget {
  final List<Gen05406Config> configs;
  const Gen05406Widget({super.key, required this.configs});
...
void main() async {
  final configs = [
    Gen05406Config(
      configId: 'gen05406-cfg-001',
      widgetId: 'gen-05406_widgetId',
      dataSource: 'gen-05406_dataSource',
      metricLabel: 'gen-05406_metricLabel',
      refreshIntervalMs: 'gen-05406_refreshIntervalMs',
      traceId:                 'trace-gen05406-001',
      originSourceId:          'origin-gen05406',
      immediatePredecessorId:  'pred-gen05406-001',
