...
enum Rcgla002A18ExecutionStatus { pending, running, complete, failed }
...
void main() async {
  ...
  final out = await Rcgla002A18Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('RCGLA-002-A18 [Complete / Partial / Not Complete] → $out');
}
