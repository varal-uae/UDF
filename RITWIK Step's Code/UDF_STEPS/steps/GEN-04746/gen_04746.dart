...
class Gen04746ValidationResult {
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Gen04746ConformanceLevel.pass_: return 'Pass';
      case Gen04746ConformanceLevel.fail_: return 'Fail';
    }
  }
}
  ...
  static Gen04746ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return Gen04746ValidationResult(
        ...
        conformanceRate: 0.0,
        conformanceLevel: Gen04746ConformanceLevel.fail_,
    ...
    final level = rate >= _floor
        ? Gen04746ConformanceLevel.pass_
        : Gen04746ConformanceLevel.fail_;
    return Gen04746ValidationResult(
...
Map<String, dynamic> gen_04746Dlq(
...
void main() async {
  ...
  final out = await Gen04746Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('GEN-04746 [Pass / Fail] → $out');
}
