...
Map<String, dynamic> gen_05362Dlq(
...
void main() async {
  ...
  final out = await Gen05362Pipeline.run(configs: configs, userId: 'ritwik-udf');
  print('GEN-05362 [Complete / Partial / Not Complete] → $out');
}
