...
// Description: Add Branch.io SDK to Gradle and CocoaPods
...
// Date:        24-Sep-2026
// Source file: GEN-00498_branch_io_sdk.md
// ============================================================
...
// EC error codes: EC-GEN00498-001 through EC-GEN00498-UTL
...
/// The original Markdown source for GEN-00498.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00498Executor.run()].
const String kGen00498SourceScript = r'''
...
class Gen00498Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00498-001: traceId required for GEN-00498');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00498-002: originSourceId required for GEN-00498');
    }
    return {
      'step_id':                  'GEN-00498',
      'source_language':          'Markdown',
      'source_script':            kGen00498SourceScript,
...
void main() {
  final executor = Gen00498Executor(
  ...
  print('GEN-00498 manifest ready:');
