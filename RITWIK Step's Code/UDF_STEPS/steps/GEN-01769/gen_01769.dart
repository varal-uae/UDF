...
class Gen01769ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Gen01769ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Gen01769ValidationResult({
  ...
  String get conformanceOutput {
    switch (conformanceLevel) {
      case Gen01769ConformanceLevel.complete:    return 'Complete';
      case Gen01769ConformanceLevel.partial:     return 'Partial';
      case Gen01769ConformanceLevel.notComplete: return 'Not Complete';
    }
  }
}
...
class Gen01769Pipeline {
  ...
  static Gen01769ValidationResult calculateConformance({
    ...
    if (configs.isEmpty) {
      return const Gen01769ValidationResult(
        ...
        gatePass: false, ecLineRef: 'EC-GEN01769-VAL',
      );
    }
    ...
    final level      = rate >= _optimal
        ...
        : rate >= _floor
            ...
            : Gen01769ConformanceLevel.notComplete;
    return Gen01769ValidationResult(
      ...
      ecLineRef:         'EC-GEN01769-VAL',
    );
  }

  static Gen01769Config routeToRegistry(
    Gen01769Config config,
    Gen01769ValidationResult result,
  ) {
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-GEN01769-000: configs must not be empty for GEN-01769');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-GEN01769-TRI: triangular check failed for GEN-01769');
    }
...
class Gen01769Widget extends StatelessWidget {
  final List<Gen01769Config> configs;
  const Gen01769Widget({super.key, required this.configs});
