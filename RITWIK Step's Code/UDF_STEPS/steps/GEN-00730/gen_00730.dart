...
// Description: Verify 100% of gamification events log within 200ms (live test)
...
// Date:        24-Sep-2026
// Source file: GEN-00730_verify_gamification_latency.md
// ============================================================
...
// EC error codes: EC-GEN00730-001 through EC-GEN00730-UTL
...
/// The original Markdown source for GEN-00730.
/// Stored as a Dart constant so the pipeline scanner can index it.
/// Execute via [GEN-00730Executor.run()].
const String kGen00730SourceScript = r'''
# GEN-00730 — Verify 100% of gamification events log within 200ms (live test)
Metric: Event Log Latency · Pass/Fail

**Operational / verification step — not a source file.** Recorded for traceability.

## Action
During a live test session, confirm every gamification event is written within 200ms. PASS only at 100% within budget.
''';
...
class Gen00730Executor {
  ...
  Map<String, dynamic> run() {
    if (traceId.isEmpty) {
      throw ArgumentError('EC-GEN00730-001: traceId required for GEN-00730');
    }
    if (originSourceId.isEmpty) {
      throw ArgumentError('EC-GEN00730-002: originSourceId required for GEN-00730');
    }
    return {
      'step_id':                  'GEN-00730',
      'source_language':          'Markdown',
      'source_script':            kGen00730SourceScript,
...
void main() {
  final executor = Gen00730Executor(
  ...
  print('GEN-00730 manifest ready:');
