...
class Gen03202ValidationResult {
  final int    totalRecords;
  final int    conformantRecords;
  final int    violationCount;
  final double conformanceRate;
  final Gen03202ConformanceLevel conformanceLevel;
  final bool   gatePass;
  final String ecLineRef;

  const Gen03202ValidationResult({
...
class Gen03202Pipeline {
  ...
  static Gen03202ValidationResult calculateConformance({
    ...
    return Gen03202ValidationResult(
      ...
      ecLineRef:         'EC-GEN03202-VAL',
    );
  }

  static Gen03202Config routeToRegistry(
    Gen03202Config config,
    Gen03202ValidationResult result,
  ) {
  ...
  static Future<Map<String, dynamic>> run({
    ...
    if (configs.isEmpty) {
      throw ArgumentError('EC-GEN03202-000: configs must not be empty for GEN-03202');
    }
    ...
    if (!triangularCheck(configs.length, p4.length)) {
      throw ArgumentError('EC-GEN03202-TRI: triangular check failed for GEN-03202');
    }
...
class Gen03202Widget extends StatelessWidget {
  final List<Gen03202Config> configs;
  const Gen03202Widget({super.key, required this.configs});
