...
class Dsdd02314Pipeline {
  ...
  static void executeGeneratesStep1(Dsdd02314Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DSDD02314-001: ruleId required');
  }
  ...
  static void executeInjectsStep2(Dsdd02314Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DSDD02314-002: ruleId required');
  }
  ...
  static void executeAttachesStep3(Dsdd02314Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DSDD02314-003: ruleId required');
  }
  ...
  static void executeWritesStep4(Dsdd02314Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DSDD02314-004: ruleId required');
  }
  ...
  static void executeComputesStep5(Dsdd02314Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DSDD02314-005: ruleId required');
  }
  ...
  static void executeValidatesStep6(Dsdd02314Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DSDD02314-006: ruleId required');
  }
  ...
  static void executeDeterminesStep7(Dsdd02314Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DSDD02314-007: ruleId required');
  }
  ...
  static void executeStoresStep8(Dsdd02314Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DSDD02314-008: ruleId required');
  }
