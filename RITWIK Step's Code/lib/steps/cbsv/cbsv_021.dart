...
class Cbsv021Pipeline {
  ...
  static void executeReceivesStep1(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-002: ruleId required');
  }
  ...
  static void executeEvaluatesStep3(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-003: ruleId required');
  }
  ...
  static void executeDropsStep4(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-004: ruleId required');
  }
  ...
  static void executeExtractsStep5(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-005: ruleId required');
  }
  ...
  static void executeTransformsStep6(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-006: ruleId required');
  }
  ...
  static void executeAppliesStep7(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-007: ruleId required');
  }
  ...
  static void executeWritesStep8(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-008: ruleId required');
  }
  ...
  static void executeMeasuresStep9(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-009: ruleId required');
  }
  ...
  static void executeEmitsStep10(Cbsv021Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV021-010: ruleId required');
  }
