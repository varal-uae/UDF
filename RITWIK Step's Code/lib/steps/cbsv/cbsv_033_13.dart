...
class Cbsv03313Pipeline {
  ...
  static void executeIngestsStep1(Cbsv03313Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03313-001: ruleId required');
  }
  ...
  static void executeJoinsStep2(Cbsv03313Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03313-002: ruleId required');
  }
  ...
  static void executeMapsStep3(Cbsv03313Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03313-003: ruleId required');
  }
  ...
  static void executeValidatesStep4(Cbsv03313Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03313-004: ruleId required');
  }
  ...
  static void executeGeneratesStep5(Cbsv03313Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03313-005: ruleId required');
  }
  ...
  static void executeCalculatesStep6(Cbsv03313Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03313-006: ruleId required');
  }
  ...
  static void executeStoresStep7(Cbsv03313Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03313-007: ruleId required');
  }
