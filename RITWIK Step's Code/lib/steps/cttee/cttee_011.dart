...
class Cttee011Pipeline {
  ...
  static void executeReceivesStep1(Cttee011Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE011-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Cttee011Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE011-002: ruleId required');
  }
  ...
  static void executeCalculatesStep3(Cttee011Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE011-003: ruleId required');
  }
  ...
  static void executeChecksStep4(Cttee011Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE011-004: ruleId required');
  }
  ...
  static void executeChecksStep5(Cttee011Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE011-005: ruleId required');
  }
  ...
  static void executeInitializesStep6(Cttee011Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE011-006: ruleId required');
  }
  ...
  static void executeSynchronizesStep7(Cttee011Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE011-007: ruleId required');
  }
  ...
  static void executeRecordsStep8(Cttee011Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE011-008: ruleId required');
  }
