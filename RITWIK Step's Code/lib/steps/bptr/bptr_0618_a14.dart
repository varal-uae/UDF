...
class Bptr0618A14Pipeline {
  ...
  static String executeReceivesStep1(Bptr0618A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0618A14-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep2(Bptr0618A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0618A14-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeSuppressesStep3(Bptr0618A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0618A14-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeFormatsStep4(Bptr0618A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0618A14-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep5(Bptr0618A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0618A14-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep6(Bptr0618A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0618A14-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeBindsStep7(Bptr0618A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0618A14-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeUpdatesStep8(Bptr0618A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0618A14-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executePersistsStep9(Bptr0618A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0618A14-009: ruleId must not be empty');
    return entry.ruleId;
  }
