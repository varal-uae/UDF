...
class Bptr0422A06Pipeline {
  ...
  static String executeReceivesStep1(Bptr0422A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0422A06-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep2(Bptr0422A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0422A06-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeSetsStep3(Bptr0422A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0422A06-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeConfiguresStep4(Bptr0422A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0422A06-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeActivatesStep5(Bptr0422A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0422A06-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep6(Bptr0422A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0422A06-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeStoresStep7(Bptr0422A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0422A06-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAppendsStep8(Bptr0422A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0422A06-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEmitsStep9(Bptr0422A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0422A06-009: ruleId must not be empty');
    return entry.ruleId;
  }
