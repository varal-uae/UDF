...
class Bptr0176A12Pipeline {
  ...
  static String executeExtractsStep1(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeParsesStep2(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeSetsStep3(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep4(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep5(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeLinksStep6(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep7(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep8(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executePersistsStep9(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeStreamsStep10(Bptr0176A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0176A12-010: ruleId must not be empty');
    return entry.ruleId;
  }
