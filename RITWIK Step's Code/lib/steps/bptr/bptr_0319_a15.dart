...
class Bptr0319A15Pipeline {
  ...
  static String executeCapturesStep1(Bptr0319A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0319A15-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep2(Bptr0319A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0319A15-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep3(Bptr0319A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0319A15-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep4(Bptr0319A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0319A15-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep5(Bptr0319A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0319A15-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeFlagsStep6(Bptr0319A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0319A15-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAssignsStep7(Bptr0319A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0319A15-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep8(Bptr0319A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0319A15-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep9(Bptr0319A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0319A15-009: ruleId must not be empty');
    return entry.ruleId;
  }
