...
class Bptr0287A03Pipeline {
  ...
  static String executeReceivesStep1(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMeasuresStep2(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeComparesStep3(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep4(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeFiltersStep5(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeVerifiesStep6(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeTriggersStep7(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRendersStep8(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeDispatchesStep9(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRecordsStep10(Bptr0287A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A03-010: ruleId must not be empty');
    return entry.ruleId;
  }
