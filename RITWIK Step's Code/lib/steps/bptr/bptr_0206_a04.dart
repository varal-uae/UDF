...
class Bptr0206A04Pipeline {
  ...
  static String executeCapturesStep1(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep2(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep3(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep4(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeTriggersStep5(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAppliesStep6(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRecordsStep7(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep8(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeStreamsStep9(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executePersistsStep10(Bptr0206A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0206A04-010: ruleId must not be empty');
    return entry.ruleId;
  }
