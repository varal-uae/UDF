...
class Bptr0349A07Pipeline {
  ...
  static String executeScansStep1(Bptr0349A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0349A07-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executePurgesStep2(Bptr0349A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0349A07-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeConvertsStep3(Bptr0349A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0349A07-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAppliesStep4(Bptr0349A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0349A07-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep5(Bptr0349A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0349A07-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep6(Bptr0349A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0349A07-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeInjectsStep7(Bptr0349A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0349A07-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep8(Bptr0349A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0349A07-008: ruleId must not be empty');
    return entry.ruleId;
  }
