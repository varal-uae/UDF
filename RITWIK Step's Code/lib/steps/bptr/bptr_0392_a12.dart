...
class Bptr0392A12Pipeline {
  ...
  static String executeReceivesStep1(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeInitializesStep2(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRendersStep3(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAttachesStep4(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeSetsStep5(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep6(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeUpdatesStep7(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeTriggersStep8(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRecordsStep9(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executePersistsStep10(Bptr0392A12Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0392A12-010: ruleId must not be empty');
    return entry.ruleId;
  }
