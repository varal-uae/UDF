...
class Bptr0303A07Pipeline {
  ...
  static String executeMatchesStep1(Bptr0303A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A07-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeFiltersStep2(Bptr0303A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A07-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeInjectsStep3(Bptr0303A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A07-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeInterceptsStep4(Bptr0303A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A07-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeStripsStep5(Bptr0303A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A07-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeDisplaysStep6(Bptr0303A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A07-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeUpdatesStep7(Bptr0303A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A07-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRecordsStep8(Bptr0303A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A07-008: ruleId must not be empty');
    return entry.ruleId;
  }
