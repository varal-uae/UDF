...
class Bptr0035A10Pipeline {
  ...
  static String executeInterceptsStep1(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep2(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep3(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAppliesStep4(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeBindsStep5(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeInjectsStep6(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMeasuresStep7(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep8(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRecordsStep9(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep10(Bptr0035A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A10-010: ruleId must not be empty');
    return entry.ruleId;
  }
