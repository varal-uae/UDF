...
class Dprbr012Pipeline {
  ...
  static void executeIngestsStep1(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-002: ruleId required');
  }
  ...
  static void executeRejectsStep3(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-003: ruleId required');
  }
  ...
  static void executeExtractsStep4(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-004: ruleId required');
  }
  ...
  static void executeCorrelatesStep5(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-005: ruleId required');
  }
  ...
  static void executeAppliesStep6(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-006: ruleId required');
  }
  ...
  static void executeCalculatesStep7(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-007: ruleId required');
  }
  ...
  static void executeEvaluatesStep8(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-008: ruleId required');
  }
  ...
  static void executeAssignsStep9(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-009: ruleId required');
  }
  ...
  static void executeWritesStep10(Dprbr012Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPRBR012-010: ruleId required');
  }
