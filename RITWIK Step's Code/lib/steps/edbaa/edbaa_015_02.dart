...
class Edbaa01502Pipeline {
  ...
  static void executeExtractsStep1(Edbaa01502Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA01502-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Edbaa01502Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA01502-002: ruleId required');
  }
  ...
  static void executeVerifiesStep3(Edbaa01502Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA01502-003: ruleId required');
  }
  ...
  static void executeCalculatesStep4(Edbaa01502Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA01502-004: ruleId required');
  }
  ...
  static void executeEvaluatesStep5(Edbaa01502Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA01502-005: ruleId required');
  }
  ...
  static void executeCompilesStep6(Edbaa01502Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA01502-006: ruleId required');
  }
  ...
  static void executeAppliesStep7(Edbaa01502Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA01502-007: ruleId required');
  }
  ...
  static void executeGeneratesStep8(Edbaa01502Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA01502-008: ruleId required');
  }
  ...
  static void executeWritesStep9(Edbaa01502Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA01502-009: ruleId required');
  }
