...
class Edbaa024A07Pipeline {
  ...
  static void executeReceivesStep1(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-001: ruleId required');
  }
  ...
  static void executeExtractsStep2(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-002: ruleId required');
  }
  ...
  static void executeRetrievesStep3(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-003: ruleId required');
  }
  ...
  static void executeUpdatesStep4(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-004: ruleId required');
  }
  ...
  static void executeLogsStep5(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-005: ruleId required');
  }
  ...
  static void executeAnchorsStep6(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-006: ruleId required');
  }
  ...
  static void executeCalculatesStep7(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-007: ruleId required');
  }
  ...
  static void executeEvaluatesStep8(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-008: ruleId required');
  }
  ...
  static void executeRecordsStep9(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-009: ruleId required');
  }
  ...
  static void executeRoutesStep10(Edbaa024A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA024A07-010: ruleId required');
  }
