...
class Edbaa004A10Pipeline {
  ...
  static void executeExtractsStep1(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-001: ruleId required');
  }
  ...
  static void executeDifferentiatesStep2(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-002: ruleId required');
  }
  ...
  static void executeSelectsStep3(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-003: ruleId required');
  }
  ...
  static void executeEvaluatesStep4(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-004: ruleId required');
  }
  ...
  static void executeCalculatesStep5(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-005: ruleId required');
  }
  ...
  static void executeBuildsStep6(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-006: ruleId required');
  }
  ...
  static void executeMapsStep7(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-007: ruleId required');
  }
  ...
  static void executeValidatesStep8(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-008: ruleId required');
  }
  ...
  static void executeAssignsStep9(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-009: ruleId required');
  }
  ...
  static void executeEmitsStep10(Edbaa004A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA004A10-010: ruleId required');
  }
