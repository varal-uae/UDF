...
class Cuitc012A08Pipeline {
  ...
  static void executeInitializesStep1(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-001: ruleId required');
  }
  ...
  static void executeFetchesStep2(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-002: ruleId required');
  }
  ...
  static void executeValidatesStep3(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-003: ruleId required');
  }
  ...
  static void executeAppliesStep4(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-004: ruleId required');
  }
  ...
  static void executeBindsStep5(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-005: ruleId required');
  }
  ...
  static void executeConfiguresStep6(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-006: ruleId required');
  }
  ...
  static void executeAppliesStep7(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-007: ruleId required');
  }
  ...
  static void executeMeasuresStep8(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-008: ruleId required');
  }
  ...
  static void executeEvaluatesStep9(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-009: ruleId required');
  }
  ...
  static void executePersistsStep10(Cuitc012A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A08-010: ruleId required');
  }
