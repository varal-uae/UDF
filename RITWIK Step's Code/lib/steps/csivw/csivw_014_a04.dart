...
class Csivw014A04Pipeline {
  ...
  static void executeCapturesStep1(Csivw014A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A04-001: ruleId required');
  }
  ...
  static void executeThrottlesStep2(Csivw014A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A04-002: ruleId required');
  }
  ...
  static void executeTransmitsStep3(Csivw014A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A04-003: ruleId required');
  }
  ...
  static void executeReceivesStep4(Csivw014A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A04-004: ruleId required');
  }
  ...
  static void executeUpdatesStep5(Csivw014A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A04-005: ruleId required');
  }
  ...
  static void executeDisablesStep6(Csivw014A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A04-006: ruleId required');
  }
  ...
  static void executeIncrementsStep7(Csivw014A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A04-007: ruleId required');
  }
  ...
  static void executeReplacesStep8(Csivw014A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A04-008: ruleId required');
  }
  ...
  static void executeWritesStep9(Csivw014A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A04-009: ruleId required');
  }
