...
class Dpndl001A10Pipeline {
  ...
  static void executeInitializesStep1(Dpndl001A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL001A10-001: ruleId required');
  }
  ...
  static void executeAppliesStep2(Dpndl001A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL001A10-002: ruleId required');
  }
  ...
  static void executeMountsStep3(Dpndl001A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL001A10-003: ruleId required');
  }
  ...
  static void executeDeactivatesStep4(Dpndl001A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL001A10-004: ruleId required');
  }
  ...
  static void executeLoadsStep5(Dpndl001A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL001A10-005: ruleId required');
  }
  ...
  static void executeEvaluatesStep6(Dpndl001A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL001A10-006: ruleId required');
  }
  ...
  static void executeRecordsStep7(Dpndl001A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL001A10-007: ruleId required');
  }
  ...
  static void executeTransmitsStep8(Dpndl001A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL001A10-008: ruleId required');
  }
