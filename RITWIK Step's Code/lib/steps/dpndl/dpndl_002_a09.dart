...
class Dpndl002A09Pipeline {
  ...
  static void executeExtractsStep1(Dpndl002A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL002A09-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Dpndl002A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL002A09-002: ruleId required');
  }
  ...
  static void executeBindsStep3(Dpndl002A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL002A09-003: ruleId required');
  }
  ...
  static void executeEnforcesStep4(Dpndl002A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL002A09-004: ruleId required');
  }
  ...
  static void executeHidesStep5(Dpndl002A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL002A09-005: ruleId required');
  }
  ...
  static void executeRestrictsStep6(Dpndl002A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL002A09-006: ruleId required');
  }
  ...
  static void executeTransformsStep7(Dpndl002A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL002A09-007: ruleId required');
  }
  ...
  static void executeWritesStep8(Dpndl002A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL002A09-008: ruleId required');
  }
