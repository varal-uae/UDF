...
class Dpndl004A09Pipeline {
  ...
  static void executeExtractsStep1(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-001: ruleId required');
  }
  ...
  static void executeAppliesStep2(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-002: ruleId required');
  }
  ...
  static void executeAppliesStep3(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-003: ruleId required');
  }
  ...
  static void executeValidatesStep4(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-004: ruleId required');
  }
  ...
  static void executeSetsStep5(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-005: ruleId required');
  }
  ...
  static void executeSetsStep6(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-006: ruleId required');
  }
  ...
  static void executeEnforcesStep7(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-007: ruleId required');
  }
  ...
  static void executeEvaluatesStep8(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-008: ruleId required');
  }
  ...
  static void executeGeneratesStep9(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-009: ruleId required');
  }
  ...
  static void executeStoresStep10(Dpndl004A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL004A09-010: ruleId required');
  }
