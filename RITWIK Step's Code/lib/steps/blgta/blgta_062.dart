...
class Blgta062Pipeline {
  ...
  static String executeReceivesStep1(Blgta062Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA062-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep2(Blgta062Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA062-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep3(Blgta062Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA062-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExecutesStep4(Blgta062Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA062-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep5(Blgta062Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA062-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeUpdatesStep6(Blgta062Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA062-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep7(Blgta062Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA062-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeSetsStep8(Blgta062Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA062-008: ruleId must not be empty');
    return entry.ruleId;
  }
