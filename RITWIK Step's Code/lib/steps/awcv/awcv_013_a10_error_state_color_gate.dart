...
class Awcv013A10ErrorStateColorGate {
  ...
  static Map<String, dynamic>? locateConfiguration(String repoPath) {
    assert(repoPath.isNotEmpty, 'EC-AWCV013A10-001: repo path must not be empty');
  ...
  static Map<String, dynamic> extractParameters(Map<String, dynamic> config) {
    ...
    assert(
      ...
      'EC-AWCV013A10-002: all 5 error state fields must be non-null',
    );
  ...
  static ErrorStateColorEntry registerRule(ErrorStateColorEntry entry) {
    assert(entry.errorColorToken == ErrorStateColorEntry.kRequiredErrorToken,
      'EC-AWCV013A10-003: errorColorToken must be md.sys.color.error');
    assert(entry.contrastRatio >= ErrorStateColorEntry.kMinContrastRatio,
      'EC-AWCV013A10-003: contrastRatio < 4.5');
    assert(entry.errorContainerToken == ErrorStateColorEntry.kRequiredContainerToken,
      'EC-AWCV013A10-003: errorContainerToken must be md.sys.color.errorContainer');
  ...
  static String bindToTarget(String ruleId, String errorColorToken) {
    assert(ruleId.isNotEmpty, 'EC-AWCV013A10-005: FK bind requires valid ruleId');
