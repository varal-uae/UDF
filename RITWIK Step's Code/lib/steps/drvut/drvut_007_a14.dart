...
class Drvut007A14Pipeline {
  ...
  static void executeInitializesStep1(Drvut007A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT007A14-001: ruleId required');
  }
  ...
  static void executeBindsStep2(Drvut007A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT007A14-002: ruleId required');
  }
  ...
  static void executeInterceptsStep3(Drvut007A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT007A14-003: ruleId required');
  }
  ...
  static void executeEvaluatesStep4(Drvut007A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT007A14-004: ruleId required');
  }
  ...
  static void executeRejectsStep5(Drvut007A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT007A14-005: ruleId required');
  }
  ...
  static void executeMeasuresStep6(Drvut007A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT007A14-006: ruleId required');
  }
  ...
  static void executeGeneratesStep7(Drvut007A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT007A14-007: ruleId required');
  }
  ...
  static void executeLogsStep8(Drvut007A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT007A14-008: ruleId required');
  }
  ...
  static void executeRecordsStep9(Drvut007A14Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT007A14-009: ruleId required');
  }
