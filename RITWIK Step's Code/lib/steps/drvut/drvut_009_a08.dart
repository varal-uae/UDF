...
class Drvut009A08Pipeline {
  ...
  static void executeInitializesStep1(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-001: ruleId required');
  }
  ...
  static void executeAnchorsStep2(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-002: ruleId required');
  }
  ...
  static void executeCalculatesStep3(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-003: ruleId required');
  }
  ...
  static void executeSubtractsStep4(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-004: ruleId required');
  }
  ...
  static void executeMapsStep5(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-005: ruleId required');
  }
  ...
  static void executeEvaluatesStep6(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-006: ruleId required');
  }
  ...
  static void executeTriggersStep7(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-007: ruleId required');
  }
  ...
  static void executeRevokesStep8(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-008: ruleId required');
  }
  ...
  static void executeStreamsStep9(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-009: ruleId required');
  }
  ...
  static void executePersistsStep10(Drvut009A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT009A08-010: ruleId required');
  }
