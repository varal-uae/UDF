...
class Cpnca006A07Pipeline {
  ...
  static void executeAttachesStep1(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-001: ruleId required');
  }
  ...
  static void executeCalculatesStep2(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-002: ruleId required');
  }
  ...
  static void executeEvaluatesStep3(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-003: ruleId required');
  }
  ...
  static void executeValidatesStep4(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-004: ruleId required');
  }
  ...
  static void executeExtractsStep5(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-005: ruleId required');
  }
  ...
  static void executePositionsStep6(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-006: ruleId required');
  }
  ...
  static void executeUnmountsStep7(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-007: ruleId required');
  }
  ...
  static void executeCalculatesStep8(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-008: ruleId required');
  }
  ...
  static void executeRoutesStep9(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-009: ruleId required');
  }
  ...
  static void executeWritesStep10(Cpnca006A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A07-010: ruleId required');
  }
