...
class Bpwso035Pipeline {
  ...
  static String executeIngestsStep1(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep2(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep3(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeComputesStep4(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep5(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAttachesStep6(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep7(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep8(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep9(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeLogsStep10(Bpwso035Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO035-010: ruleId must not be empty');
    return entry.ruleId;
  }
