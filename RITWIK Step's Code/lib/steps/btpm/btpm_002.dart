...
class Btpm002Pipeline {
  ...
  static void executeInterceptsStep1(Btpm002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM002-001: ruleId required');
  }
  ...
  static void executeExtractsStep2(Btpm002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM002-002: ruleId required');
  }
  ...
  static void executeComparesStep3(Btpm002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM002-003: ruleId required');
  }
  ...
  static void executeTerminatesStep4(Btpm002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM002-004: ruleId required');
  }
  ...
  static void executeParsesStep5(Btpm002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM002-005: ruleId required');
  }
  ...
  static void executeCalculatesStep6(Btpm002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM002-006: ruleId required');
  }
  ...
  static void executeBindsStep7(Btpm002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM002-007: ruleId required');
  }
  ...
  static void executeStreamsStep8(Btpm002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM002-008: ruleId required');
  }
