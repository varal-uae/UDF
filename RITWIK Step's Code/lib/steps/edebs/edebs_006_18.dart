...
class Edebs00618Pipeline {
  ...
  static void executeInitializesStep1(Edebs00618Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00618-001: ruleId required');
  }
  ...
  static void executeCreatesStep2(Edebs00618Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00618-002: ruleId required');
  }
  ...
  static void executeIngestsStep3(Edebs00618Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00618-003: ruleId required');
  }
  ...
  static void executeChecksStep4(Edebs00618Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00618-004: ruleId required');
  }
  ...
  static void executeAssignsStep5(Edebs00618Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00618-005: ruleId required');
  }
  ...
  static void executeMapsStep6(Edebs00618Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00618-006: ruleId required');
  }
  ...
  static void executeInsertsStep7(Edebs00618Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00618-007: ruleId required');
  }
  ...
  static void executeUpdatesStep8(Edebs00618Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00618-008: ruleId required');
  }
