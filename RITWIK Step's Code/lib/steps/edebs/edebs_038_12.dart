...
class Edebs03812Pipeline {
  ...
  static void executeIngestsStep1(Edebs03812Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03812-001: ruleId required');
  }
  ...
  static void executeEvaluatesStep2(Edebs03812Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03812-002: ruleId required');
  }
  ...
  static void executeExtractsStep3(Edebs03812Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03812-003: ruleId required');
  }
  ...
  static void executeValidatesStep4(Edebs03812Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03812-004: ruleId required');
  }
  ...
  static void executeRendersStep5(Edebs03812Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03812-005: ruleId required');
  }
  ...
  static void executeRendersStep6(Edebs03812Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03812-006: ruleId required');
  }
  ...
  static void executeRecordsStep7(Edebs03812Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03812-007: ruleId required');
  }
  ...
  static void executeRoutesStep8(Edebs03812Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03812-008: ruleId required');
  }
