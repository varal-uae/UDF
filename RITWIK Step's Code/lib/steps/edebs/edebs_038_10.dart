...
class Edebs03810Pipeline {
  ...
  static void executeIngestsStep1(Edebs03810Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03810-001: ruleId required');
  }
  ...
  static void executeCapturesStep2(Edebs03810Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03810-002: ruleId required');
  }
  ...
  static void executeMapsStep3(Edebs03810Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03810-003: ruleId required');
  }
  ...
  static void executeRetrievesStep4(Edebs03810Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03810-004: ruleId required');
  }
  ...
  static void executeConstructsStep5(Edebs03810Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03810-005: ruleId required');
  }
  ...
  static void executeRendersStep6(Edebs03810Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03810-006: ruleId required');
  }
  ...
  static void executeCalculatesStep7(Edebs03810Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03810-007: ruleId required');
  }
  ...
  static void executeEvaluatesStep8(Edebs03810Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03810-008: ruleId required');
  }
  ...
  static void executeLogsStep9(Edebs03810Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03810-009: ruleId required');
  }
