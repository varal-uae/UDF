...
class Dlqdp01501Pipeline {
  ...
  static void executeExtractsStep1(Dlqdp01501Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DLQDP01501-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Dlqdp01501Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DLQDP01501-002: ruleId required');
  }
  ...
  static void executeFiltersStep3(Dlqdp01501Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DLQDP01501-003: ruleId required');
  }
  ...
  static void executeMapsStep4(Dlqdp01501Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DLQDP01501-004: ruleId required');
  }
  ...
  static void executeEmbedsStep5(Dlqdp01501Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DLQDP01501-005: ruleId required');
  }
  ...
  static void executeCalculatesStep6(Dlqdp01501Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DLQDP01501-006: ruleId required');
  }
  ...
  static void executeVerifiesStep7(Dlqdp01501Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DLQDP01501-007: ruleId required');
  }
  ...
  static void executeAttachesStep8(Dlqdp01501Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DLQDP01501-008: ruleId required');
  }
  ...
  static void executeWritesStep9(Dlqdp01501Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DLQDP01501-009: ruleId required');
  }
