...
mixin LineageTraceSensor<T extends StatefulWidget> on State<T> {
  ...
  // -------------------------------------------------------------------------
  // EC:7 — Calculate Automated Test Coverage.
...
class _LineageTrackedWidgetState extends State<LineageTrackedWidget>
  ...
  void initState() {
    super.initState();
    captureIdle(); // EC:3 — IDLE state captured
  }

  Future<void> _loadData() async {
    setState(() => _loading = true);
    // EC:3 — LOADING/SUCCESS captured with cross-table check
    await captureAsync(
