...
class BiometricTriggerTestEntry {
  ...
  }) : assert(dialogLatencyMs >= 0,
         'EC-BDAE011A09-002: dialogLatencyMs must be >= 0');
...
class Bdae011A09BiometricTriggerTest {
  ...
  static Map<String, dynamic>? locateConfiguration(String repoPath) {
    assert(repoPath.isNotEmpty, 'EC-BDAE011A09-001: repo path must not be empty');
  ...
  static Map<String, dynamic> extractParameters(Map<String, dynamic> config) {
    ...
    assert(
      ...
      'EC-BDAE011A09-002: all 5 biometric test fields must be non-null',
    );
  ...
  static BiometricTriggerTestEntry registerRule(BiometricTriggerTestEntry entry) {
    assert(entry.testCoverage >= 0.90,
      'EC-BDAE011A09-003: testCoverage must be >= 0.90');
  ...
  static String bindToTarget(String ruleId, String testType) {
    assert(ruleId.isNotEmpty, 'EC-BDAE011A09-005: FK bind requires valid ruleId');
            ...
            return Card(
              ...
              child: ListTile(
                ...
                subtitle: Text(
                  ...
                  style: TextStyle(fontSize: 11, color: latencyOk ? null : const Color(0xFFD93025))),
                trailing: Chip(
