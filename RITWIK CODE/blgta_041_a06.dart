...
class Blgta041A06Pipeline {
  ...
  static String executeInterceptsStep1(Blgta041A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A06-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep2(Blgta041A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A06-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAssignsStep3(Blgta041A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A06-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep4(Blgta041A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A06-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAttachesStep5(Blgta041A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A06-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep6(Blgta041A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A06-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep7(Blgta041A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A06-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeForwardsStep8(Blgta041A06Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A06-008: ruleId must not be empty');
    return entry.ruleId;
  }
