...
class Bpwso02708Pipeline {
  ...
  static String executeIngestsStep1(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeScansStep2(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeScansStep3(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeStripsStep4(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeStripsStep5(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep6(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep7(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep8(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAssignsStep9(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep10(Bpwso02708Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO02708-010: ruleId must not be empty');
    return entry.ruleId;
  }
