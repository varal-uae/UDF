...
class Cpnca019A13Pipeline {
  ...
  static void executeMonitorsStep1(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-001: ruleId required');
  }
  ...
  static void executeCapturesStep2(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-002: ruleId required');
  }
  ...
  static void executeMapsStep3(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-003: ruleId required');
  }
  ...
  static void executeEvaluatesStep4(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-004: ruleId required');
  }
  ...
  static void executeTriggersStep5(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-005: ruleId required');
  }
  ...
  static void executeRendersStep6(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-006: ruleId required');
  }
  ...
  static void executeDisablesStep7(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-007: ruleId required');
  }
  ...
  static void executeBlocksStep8(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-008: ruleId required');
  }
  ...
  static void executeAttachesStep9(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-009: ruleId required');
  }
  ...
  static void executePersistsStep10(Cpnca019A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA019A13-010: ruleId required');
  }
