...
class Csivw012A15Pipeline {
  ...
  static void executeCountsStep1(Csivw012A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW012A15-001: ruleId required');
  }
  ...
  static void executeComparesStep2(Csivw012A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW012A15-002: ruleId required');
  }
  ...
  static void executeRendersStep3(Csivw012A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW012A15-003: ruleId required');
  }
  ...
  static void executeLocksStep4(Csivw012A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW012A15-004: ruleId required');
  }
  ...
  static void executeValidatesStep5(Csivw012A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW012A15-005: ruleId required');
  }
  ...
  static void executeRoutesStep6(Csivw012A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW012A15-006: ruleId required');
  }
  ...
  static void executeDisablesStep7(Csivw012A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW012A15-007: ruleId required');
  }
  ...
  static void executeMonitorsStep8(Csivw012A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW012A15-008: ruleId required');
  }
  ...
  static void executeWritesStep9(Csivw012A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW012A15-009: ruleId required');
  }
