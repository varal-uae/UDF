...
class Cfcst002Pipeline {
  ...
  static void executeReceivesStep1(Cfcst002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST002-001: ruleId required');
  }
  ...
  static void executeExtractsStep2(Cfcst002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST002-002: ruleId required');
  }
  ...
  static void executeComparesStep3(Cfcst002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST002-003: ruleId required');
  }
  ...
  static void executeTerminatesStep4(Cfcst002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST002-004: ruleId required');
  }
  ...
  static void executeGeneratesStep5(Cfcst002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST002-005: ruleId required');
  }
  ...
  static void executeRoutesStep6(Cfcst002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST002-006: ruleId required');
  }
  ...
  static void executeStreamsStep7(Cfcst002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST002-007: ruleId required');
  }
  ...
  static void executeUpdatesStep8(Cfcst002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST002-008: ruleId required');
  }
