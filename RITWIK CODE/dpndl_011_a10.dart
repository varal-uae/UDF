...
class Dpndl011A10Pipeline {
  ...
  static void executeInitializesStep1(Dpndl011A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL011A10-001: ruleId required');
  }
  ...
  static void executeAllocatesStep2(Dpndl011A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL011A10-002: ruleId required');
  }
  ...
  static void executeEmbedsStep3(Dpndl011A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL011A10-003: ruleId required');
  }
  ...
  static void executeBindsStep4(Dpndl011A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL011A10-004: ruleId required');
  }
  ...
  static void executePositionsStep5(Dpndl011A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL011A10-005: ruleId required');
  }
  ...
  static void executeInjectsStep6(Dpndl011A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL011A10-006: ruleId required');
  }
  ...
  static void executeValidatesStep7(Dpndl011A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL011A10-007: ruleId required');
  }
  ...
  static void executeTransfersStep8(Dpndl011A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL011A10-008: ruleId required');
  }
