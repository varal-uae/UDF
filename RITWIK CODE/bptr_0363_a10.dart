...
class Bptr0363A10Pipeline {
  ...
  static String executeExtractsStep1(Bptr0363A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0363A10-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRetrievesStep2(Bptr0363A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0363A10-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep3(Bptr0363A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0363A10-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep4(Bptr0363A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0363A10-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeSetsStep5(Bptr0363A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0363A10-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep6(Bptr0363A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0363A10-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeStoresStep7(Bptr0363A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0363A10-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEmitsStep8(Bptr0363A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0363A10-008: ruleId must not be empty');
    return entry.ruleId;
  }
