...
class Bptr0377A11Pipeline {
  ...
  static String executeReceivesStep1(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeFetchesStep2(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAssignsStep3(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAssignsStep4(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAssignsStep5(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAssignsStep6(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep7(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeSetsStep8(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep9(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep10(Bptr0377A11Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0377A11-010: ruleId must not be empty');
    return entry.ruleId;
  }
