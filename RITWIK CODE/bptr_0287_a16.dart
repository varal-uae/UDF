...
class Bptr0287A16Pipeline {
  ...
  static String executeCapturesStep1(Bptr0287A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A16-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep2(Bptr0287A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A16-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep3(Bptr0287A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A16-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeResetsStep4(Bptr0287A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A16-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeFiltersStep5(Bptr0287A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A16-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep6(Bptr0287A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A16-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeTriggersStep7(Bptr0287A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A16-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep8(Bptr0287A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A16-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRecordsStep9(Bptr0287A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0287A16-009: ruleId must not be empty');
    return entry.ruleId;
  }
