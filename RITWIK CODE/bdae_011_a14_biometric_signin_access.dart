...
class BiometricAccessEntry {
  ...
  }) : assert(falseAcceptanceRate >= 0.0,
         'EC-BDAE011A14-002: falseAcceptanceRate must be >= 0.0');
...
class Bdae011A14BiometricSignInAccess {
  ...
  static Map<String, dynamic>? locateConfiguration(String repoPath) {
    assert(repoPath.isNotEmpty, 'EC-BDAE011A14-001: repo path must not be empty');
  ...
  static Map<String, dynamic> extractParameters(Map<String, dynamic> config) {
    ...
    assert(
      ...
      'EC-BDAE011A14-002: all 5 access fields must be non-null',
    );
  ...
  static BiometricAccessEntry registerRule(BiometricAccessEntry entry) {
    assert(entry.falseAcceptanceRate < BiometricAccessEntry.kMaxFalseAcceptance,
      'EC-BDAE011A14-003: falseAcceptanceRate >= 0.0001 — FIDO2 ceiling exceeded');
    assert(entry.reliabilityRate >= BiometricAccessEntry.kFloor,
      'EC-BDAE011A14-003: reliabilityRate < 0.95 — FIDO2 floor not met');
  ...
  static String bindToTarget(String ruleId, String userRole) {
    assert(ruleId.isNotEmpty, 'EC-BDAE011A14-005: FK bind requires valid ruleId');
        ...
        if (scan.falseAcceptanceViolations > 0)
          Padding(
            ...
            child: Text(
              ...
              style: const TextStyle(fontSize: 11, color: Color(0xFFD93025), fontWeight: FontWeight.bold),
            ),
          ),
