...
class Ccbpb00806Pipeline {
  ...
  static void executeReceivesStep1(Ccbpb00806Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB00806-001: ruleId required');
  }
  ...
  static void executeRetrievesStep2(Ccbpb00806Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB00806-002: ruleId required');
  }
  ...
  static void executeComparesStep3(Ccbpb00806Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB00806-003: ruleId required');
  }
  ...
  static void executeFiltersStep4(Ccbpb00806Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB00806-004: ruleId required');
  }
  ...
  static void executeIsolatesStep5(Ccbpb00806Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB00806-005: ruleId required');
  }
  ...
  static void executeAppliesStep6(Ccbpb00806Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB00806-006: ruleId required');
  }
  ...
  static void executeUpdatesStep7(Ccbpb00806Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB00806-007: ruleId required');
  }
  ...
  static void executeValidatesStep8(Ccbpb00806Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB00806-008: ruleId required');
  }
  ...
  static void executeWritesStep9(Ccbpb00806Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB00806-009: ruleId required');
  }
