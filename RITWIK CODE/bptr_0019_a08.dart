...
class Bptr0019A08Pipeline {
  ...
  static String executeExtractsStep1(Bptr0019A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A08-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeLocksStep2(Bptr0019A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A08-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeLocksStep3(Bptr0019A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A08-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeSetsStep4(Bptr0019A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A08-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeDisablesStep5(Bptr0019A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A08-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep6(Bptr0019A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A08-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep7(Bptr0019A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A08-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAssignsStep8(Bptr0019A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A08-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep9(Bptr0019A08Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A08-009: ruleId must not be empty');
    return entry.ruleId;
  }
