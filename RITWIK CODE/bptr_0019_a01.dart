...
class Bptr0019A01Pipeline {
  ...
  static String executeExtractsStep1(Bptr0019A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A01-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep2(Bptr0019A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A01-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeLocksStep3(Bptr0019A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A01-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeLocksStep4(Bptr0019A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A01-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeSetsStep5(Bptr0019A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A01-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeDisablesStep6(Bptr0019A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A01-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep7(Bptr0019A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A01-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep8(Bptr0019A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A01-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep9(Bptr0019A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0019A01-009: ruleId must not be empty');
    return entry.ruleId;
  }
