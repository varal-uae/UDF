...
class Drvut008A04Pipeline {
  ...
  static void executeInitializesStep1(Drvut008A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT008A04-001: ruleId required');
  }
  ...
  static void executeBindsStep2(Drvut008A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT008A04-002: ruleId required');
  }
  ...
  static void executeValidatesStep3(Drvut008A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT008A04-003: ruleId required');
  }
  ...
  static void executeTriggersStep4(Drvut008A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT008A04-004: ruleId required');
  }
  ...
  static void executeDisablesStep5(Drvut008A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT008A04-005: ruleId required');
  }
  ...
  static void executeCapturesStep6(Drvut008A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT008A04-006: ruleId required');
  }
  ...
  static void executeEnablesStep7(Drvut008A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT008A04-007: ruleId required');
  }
  ...
  static void executeRoutesStep8(Drvut008A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT008A04-008: ruleId required');
  }
  ...
  static void executeRoutesStep9(Drvut008A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT008A04-009: ruleId required');
  }
