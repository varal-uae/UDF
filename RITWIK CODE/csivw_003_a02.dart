...
class Csivw003A02Pipeline {
  ...
  static void executeIngestsStep1(Csivw003A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW003A02-001: ruleId required');
  }
  ...
  static void executeParsesStep2(Csivw003A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW003A02-002: ruleId required');
  }
  ...
  static void executeParsesStep3(Csivw003A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW003A02-003: ruleId required');
  }
  ...
  static void executeValidatesStep4(Csivw003A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW003A02-004: ruleId required');
  }
  ...
  static void executeMapsStep5(Csivw003A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW003A02-005: ruleId required');
  }
  ...
  static void executeAppliesStep6(Csivw003A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW003A02-006: ruleId required');
  }
  ...
  static void executeMapsStep7(Csivw003A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW003A02-007: ruleId required');
  }
  ...
  static void executeRegistersStep8(Csivw003A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW003A02-008: ruleId required');
  }
