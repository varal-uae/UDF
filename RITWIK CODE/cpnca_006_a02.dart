...
class Cpnca006A02Pipeline {
  ...
  static void executeExtractsStep1(Cpnca006A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A02-001: ruleId required');
  }
  ...
  static void executeQueriesStep2(Cpnca006A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A02-002: ruleId required');
  }
  ...
  static void executeCalculatesStep3(Cpnca006A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A02-003: ruleId required');
  }
  ...
  static void executeSetsStep4(Cpnca006A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A02-004: ruleId required');
  }
  ...
  static void executeCalculatesStep5(Cpnca006A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A02-005: ruleId required');
  }
  ...
  static void executeEvaluatesStep6(Cpnca006A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A02-006: ruleId required');
  }
  ...
  static void executeSetsStep7(Cpnca006A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A02-007: ruleId required');
  }
  ...
  static void executeUnmountsStep8(Cpnca006A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A02-008: ruleId required');
  }
  ...
  static void executeLogsStep9(Cpnca006A02Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CPNCA006A02-009: ruleId required');
  }
