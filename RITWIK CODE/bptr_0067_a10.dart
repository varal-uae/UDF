...
class Bptr0067A10Pipeline {
  ...
  static String executeExtractsStep1(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep2(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAnchorsStep3(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executePlacesStep4(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEmbedsStep5(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCollapsesStep6(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep7(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep8(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep9(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeTransmitsStep10(Bptr0067A10Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0067A10-010: ruleId must not be empty');
    return entry.ruleId;
  }
