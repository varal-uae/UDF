...
class Cttee009Pipeline {
  ...
  static void executeReceivesStep1(Cttee009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE009-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Cttee009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE009-002: ruleId required');
  }
  ...
  static void executeSetsStep3(Cttee009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE009-003: ruleId required');
  }
  ...
  static void executeExtractsStep4(Cttee009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE009-004: ruleId required');
  }
  ...
  static void executeCalculatesStep5(Cttee009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE009-005: ruleId required');
  }
  ...
  static void executeEvaluatesStep6(Cttee009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE009-006: ruleId required');
  }
  ...
  static void executeAssignsStep7(Cttee009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE009-007: ruleId required');
  }
  ...
  static void executeWritesStep8(Cttee009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE009-008: ruleId required');
  }
  ...
  static void executeEmitsStep9(Cttee009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CTTEE009-009: ruleId required');
  }
