...
class Edbaa002Pipeline {
  ...
  static void executeParsesStep1(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-001: ruleId required');
  }
  ...
  static void executeComparesStep2(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-002: ruleId required');
  }
  ...
  static void executeRejectsStep3(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-003: ruleId required');
  }
  ...
  static void executeExtractsStep4(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-004: ruleId required');
  }
  ...
  static void executeValidatesStep5(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-005: ruleId required');
  }
  ...
  static void executeRetrievesStep6(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-006: ruleId required');
  }
  ...
  static void executeFormatsStep7(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-007: ruleId required');
  }
  ...
  static void executeCalculatesStep8(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-008: ruleId required');
  }
  ...
  static void executeMapsStep9(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-009: ruleId required');
  }
  ...
  static void executeLogsStep10(Edbaa002Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDBAA002-010: ruleId required');
  }
