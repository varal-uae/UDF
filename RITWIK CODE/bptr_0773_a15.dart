...
class Bptr0773A15Pipeline {
  ...
  static String executeLocksStep1(Bptr0773A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0773A15-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeInjectsStep2(Bptr0773A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0773A15-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeInjectsStep3(Bptr0773A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0773A15-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEnforcesStep4(Bptr0773A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0773A15-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeProgramsStep5(Bptr0773A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0773A15-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep6(Bptr0773A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0773A15-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep7(Bptr0773A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0773A15-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep8(Bptr0773A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0773A15-008: ruleId must not be empty');
    return entry.ruleId;
  }
