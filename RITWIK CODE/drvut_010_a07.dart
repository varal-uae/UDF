...
class Drvut010A07Pipeline {
  ...
  static void executeExtractsStep1(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-001: ruleId required');
  }
  ...
  static void executeEvaluatesStep2(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-002: ruleId required');
  }
  ...
  static void executeTriggersStep3(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-003: ruleId required');
  }
  ...
  static void executeInjectsStep4(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-004: ruleId required');
  }
  ...
  static void executeFlipsStep5(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-005: ruleId required');
  }
  ...
  static void executeLocksStep6(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-006: ruleId required');
  }
  ...
  static void executeCalculatesStep7(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-007: ruleId required');
  }
  ...
  static void executeValidatesStep8(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-008: ruleId required');
  }
  ...
  static void executeLogsStep9(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-009: ruleId required');
  }
  ...
  static void executeWritesStep10(Drvut010A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DRVUT010A07-010: ruleId required');
  }
