...
class Cuitc012A07Pipeline {
  ...
  static void executeInitializesStep1(Cuitc012A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A07-001: ruleId required');
  }
  ...
  static void executeRegistersStep2(Cuitc012A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A07-002: ruleId required');
  }
  ...
  static void executeBindsStep3(Cuitc012A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A07-003: ruleId required');
  }
  ...
  static void executeAttachesStep4(Cuitc012A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A07-004: ruleId required');
  }
  ...
  static void executeEmbedsStep5(Cuitc012A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A07-005: ruleId required');
  }
  ...
  static void executeEvaluatesStep6(Cuitc012A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A07-006: ruleId required');
  }
  ...
  static void executeRecordsStep7(Cuitc012A07Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A07-007: ruleId required');
  }
