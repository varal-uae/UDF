...
class Bpwso00221Pipeline {
  ...
  static String executeIngestsStep1(Bpwso00221Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO00221-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep2(Bpwso00221Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO00221-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep3(Bpwso00221Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO00221-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep4(Bpwso00221Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO00221-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep5(Bpwso00221Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO00221-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep6(Bpwso00221Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO00221-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeStoresStep7(Bpwso00221Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO00221-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep8(Bpwso00221Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPWSO00221-008: ruleId must not be empty');
    return entry.ruleId;
  }
