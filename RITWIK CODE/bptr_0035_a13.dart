...
class Bptr0035A13Pipeline {
  ...
  static String executeReceivesStep1(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep2(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRetrievesStep3(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep4(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep5(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep6(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRendersStep7(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeUpdatesStep8(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeDisablesStep9(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep10(Bptr0035A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0035A13-010: ruleId must not be empty');
    return entry.ruleId;
  }
