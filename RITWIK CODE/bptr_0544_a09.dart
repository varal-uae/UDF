...
class Bptr0544A09Pipeline {
  ...
  static String executeIngestsStep1(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep2(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep3(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep4(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep5(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executePackagesStep6(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAppendsStep7(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep8(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeLinksStep9(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRegistersStep10(Bptr0544A09Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0544A09-010: ruleId must not be empty');
    return entry.ruleId;
  }
