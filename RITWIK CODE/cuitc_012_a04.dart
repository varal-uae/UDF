...
class Cuitc012A04Pipeline {
  ...
  static void executeExtractsStep1(Cuitc012A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A04-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Cuitc012A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A04-002: ruleId required');
  }
  ...
  static void executeMapsStep3(Cuitc012A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A04-003: ruleId required');
  }
  ...
  static void executeConstructsStep4(Cuitc012A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A04-004: ruleId required');
  }
  ...
  static void executeBindsStep5(Cuitc012A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A04-005: ruleId required');
  }
  ...
  static void executeConfiguresStep6(Cuitc012A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A04-006: ruleId required');
  }
  ...
  static void executeAppliesStep7(Cuitc012A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A04-007: ruleId required');
  }
  ...
  static void executeMeasuresStep8(Cuitc012A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A04-008: ruleId required');
  }
  ...
  static void executeRecordsStep9(Cuitc012A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CUITC012A04-009: ruleId required');
  }
