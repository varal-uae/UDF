...
class Bptr0725A03Pipeline {
  ...
  static String executeRetrievesStep1(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep2(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep3(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep4(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep5(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCompilesStep6(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCompilesStep7(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAppliesStep8(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep9(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRecordsStep10(Bptr0725A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0725A03-010: ruleId must not be empty');
    return entry.ruleId;
  }
