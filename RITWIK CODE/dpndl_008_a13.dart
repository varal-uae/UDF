...
class Dpndl008A13Pipeline {
  ...
  static void executeReceivesStep1(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-002: ruleId required');
  }
  ...
  static void executeSetsStep3(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-003: ruleId required');
  }
  ...
  static void executeInspectsStep4(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-004: ruleId required');
  }
  ...
  static void executeBlocksStep5(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-005: ruleId required');
  }
  ...
  static void executeAssignsStep6(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-006: ruleId required');
  }
  ...
  static void executeRecordsStep7(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-007: ruleId required');
  }
  ...
  static void executeEvaluatesStep8(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-008: ruleId required');
  }
  ...
  static void executeGeneratesStep9(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-009: ruleId required');
  }
  ...
  static void executeWritesStep10(Dpndl008A13Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-DPNDL008A13-010: ruleId required');
  }
