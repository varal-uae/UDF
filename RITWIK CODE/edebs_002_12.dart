...
class Edebs00212Pipeline {
  ...
  static void executeIngestsStep1(Edebs00212Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00212-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Edebs00212Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00212-002: ruleId required');
  }
  ...
  static void executeValidatesStep3(Edebs00212Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00212-003: ruleId required');
  }
  ...
  static void executeCalculatesStep4(Edebs00212Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00212-004: ruleId required');
  }
  ...
  static void executeEvaluatesStep5(Edebs00212Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00212-005: ruleId required');
  }
  ...
  static void executeUpdatesStep6(Edebs00212Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00212-006: ruleId required');
  }
  ...
  static void executeAppendsStep7(Edebs00212Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00212-007: ruleId required');
  }
  ...
  static void executeRoutesStep8(Edebs00212Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00212-008: ruleId required');
  }
