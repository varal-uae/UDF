...
class Edebs03805Pipeline {
  ...
  static void executeReceivesStep1(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-002: ruleId required');
  }
  ...
  static void executeExtractsStep3(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-003: ruleId required');
  }
  ...
  static void executeTransformsStep4(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-004: ruleId required');
  }
  ...
  static void executeAttachesStep5(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-005: ruleId required');
  }
  ...
  static void executeMapsStep6(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-006: ruleId required');
  }
  ...
  static void executeRendersStep7(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-007: ruleId required');
  }
  ...
  static void executeCalculatesStep8(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-008: ruleId required');
  }
  ...
  static void executeRecordsStep9(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-009: ruleId required');
  }
  ...
  static void executeTransmitsStep10(Edebs03805Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS03805-010: ruleId required');
  }
