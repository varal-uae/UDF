...
class Bptr0741A05Pipeline {
  ...
  static String executeReceivesStep1(Bptr0741A05Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0741A05-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeParsesStep2(Bptr0741A05Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0741A05-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeFetchesStep3(Bptr0741A05Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0741A05-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep4(Bptr0741A05Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0741A05-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeBindsStep5(Bptr0741A05Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0741A05-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeChecksStep6(Bptr0741A05Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0741A05-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeOutputsStep7(Bptr0741A05Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0741A05-007: ruleId must not be empty');
    return entry.ruleId;
  }
