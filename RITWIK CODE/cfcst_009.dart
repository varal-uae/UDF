...
class Cfcst009Pipeline {
  ...
  static void executeIngestsStep1(Cfcst009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST009-001: ruleId required');
  }
  ...
  static void executeValidatesStep2(Cfcst009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST009-002: ruleId required');
  }
  ...
  static void executeCalculatesStep3(Cfcst009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST009-003: ruleId required');
  }
  ...
  static void executeVerifiesStep4(Cfcst009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST009-004: ruleId required');
  }
  ...
  static void executeSetsStep5(Cfcst009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST009-005: ruleId required');
  }
  ...
  static void executeAttachesStep6(Cfcst009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST009-006: ruleId required');
  }
  ...
  static void executeStoresStep7(Cfcst009Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST009-007: ruleId required');
  }
