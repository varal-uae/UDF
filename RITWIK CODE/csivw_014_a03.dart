...
class Csivw014A03Pipeline {
  ...
  static void executeInterceptsStep1(Csivw014A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A03-001: ruleId required');
  }
  ...
  static void executeRetrievesStep2(Csivw014A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A03-002: ruleId required');
  }
  ...
  static void executeTransmitsStep3(Csivw014A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A03-003: ruleId required');
  }
  ...
  static void executeReceivesStep4(Csivw014A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A03-004: ruleId required');
  }
  ...
  static void executeEvaluatesStep5(Csivw014A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A03-005: ruleId required');
  }
  ...
  static void executeIncrementsStep6(Csivw014A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A03-006: ruleId required');
  }
  ...
  static void executeRendersStep7(Csivw014A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A03-007: ruleId required');
  }
  ...
  static void executeReplacesStep8(Csivw014A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A03-008: ruleId required');
  }
  ...
  static void executePersistsStep9(Csivw014A03Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CSIVW014A03-009: ruleId required');
  }
