...
class Bptr0303A15Pipeline {
  ...
  static String executeMatchesStep1(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeDetectsStep2(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeInjectsStep3(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeFiltersStep4(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeDropsStep5(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRendersStep6(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep7(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep8(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeLogsStep9(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-009: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep10(Bptr0303A15Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BPTR0303A15-010: ruleId must not be empty');
    return entry.ruleId;
  }
