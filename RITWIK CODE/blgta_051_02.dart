...
class Blgta05102Pipeline {
  ...
  static String executeInterceptsStep1(Blgta05102Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA05102-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeExtractsStep2(Blgta05102Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA05102-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep3(Blgta05102Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA05102-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeCalculatesStep4(Blgta05102Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA05102-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep5(Blgta05102Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA05102-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep6(Blgta05102Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA05102-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeAttachesStep7(Blgta05102Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA05102-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep8(Blgta05102Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA05102-008: ruleId must not be empty');
    return entry.ruleId;
  }
