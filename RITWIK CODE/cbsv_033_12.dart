...
class Cbsv03312Pipeline {
  ...
  static void executeImportsStep1(Cbsv03312Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03312-001: ruleId required');
  }
  ...
  static void executeExtractsStep2(Cbsv03312Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03312-002: ruleId required');
  }
  ...
  static void executeCalculatesStep3(Cbsv03312Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03312-003: ruleId required');
  }
  ...
  static void executeEvaluatesStep4(Cbsv03312Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03312-004: ruleId required');
  }
  ...
  static void executeMapsStep5(Cbsv03312Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03312-005: ruleId required');
  }
  ...
  static void executeGeneratesStep6(Cbsv03312Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03312-006: ruleId required');
  }
  ...
  static void executeStoresStep7(Cbsv03312Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CBSV03312-007: ruleId required');
  }
