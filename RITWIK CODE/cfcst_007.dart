...
class Cfcst007Pipeline {
  ...
  static void executeIngestsStep1(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-001: ruleId required');
  }
  ...
  static void executeExtractsStep2(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-002: ruleId required');
  }
  ...
  static void executeEvaluatesStep3(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-003: ruleId required');
  }
  ...
  static void executeExtractsStep4(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-004: ruleId required');
  }
  ...
  static void executeValidatesStep5(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-005: ruleId required');
  }
  ...
  static void executeMapsStep6(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-006: ruleId required');
  }
  ...
  static void executeCalculatesStep7(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-007: ruleId required');
  }
  ...
  static void executeAttachesStep8(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-008: ruleId required');
  }
  ...
  static void executeRoutesStep9(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-009: ruleId required');
  }
  ...
  static void executePersistsStep10(Cfcst007Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CFCST007-010: ruleId required');
  }
