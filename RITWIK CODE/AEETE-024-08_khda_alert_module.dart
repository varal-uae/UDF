...
class KHDAAlertModule {
  ...
  // -------------------------------------------------------------------------
  // EC:3 — Check prohibited terms (INLINE_HIGHLIGHT)
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // EC:3 — Check character limits (WARNING at 80%, BREACH at 100%)
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // EC:3 — Check mandatory field presence (MISSING_FIELD)
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // EC:3 — Run all alert checks and return combined list
  // -------------------------------------------------------------------------
