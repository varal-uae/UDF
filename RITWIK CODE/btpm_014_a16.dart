...
class Btpm014A16Pipeline {
  ...
  static void executeIngestsStep1(Btpm014A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM014A16-001: ruleId required');
  }
  ...
  static void executeExtractsStep2(Btpm014A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM014A16-002: ruleId required');
  }
  ...
  static void executeExtractsStep3(Btpm014A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM014A16-003: ruleId required');
  }
  ...
  static void executeCalculatesStep4(Btpm014A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM014A16-004: ruleId required');
  }
  ...
  static void executeValidatesStep5(Btpm014A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM014A16-005: ruleId required');
  }
  ...
  static void executeEvaluatesStep6(Btpm014A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM014A16-006: ruleId required');
  }
  ...
  static void executeWritesStep7(Btpm014A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM014A16-007: ruleId required');
  }
  ...
  static void executeUpdatesStep8(Btpm014A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM014A16-008: ruleId required');
  }
  ...
  static void executeRoutesStep9(Btpm014A16Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-BTPM014A16-009: ruleId required');
  }
