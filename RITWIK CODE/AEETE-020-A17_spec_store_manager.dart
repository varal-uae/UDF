...
class GMRDComponentSpec {
  ...
  /// EC:5 — Assemble all 8 sections into a single markdown document.
  String toMarkdown() {
...
class SpecStoreManager {
  ...
  // ---------------------------------------------------------------------------
  // EC:5 — Write artifact to library path (simulation).
