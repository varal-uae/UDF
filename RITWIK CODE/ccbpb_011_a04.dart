...
class Ccbpb011A04Pipeline {
  ...
  static void executeExtractsStep1(Ccbpb011A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB011A04-001: ruleId required');
  }
  ...
  static void executeExtractsStep2(Ccbpb011A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB011A04-002: ruleId required');
  }
  ...
  static void executeCalculatesStep3(Ccbpb011A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB011A04-003: ruleId required');
  }
  ...
  static void executeEvaluatesStep4(Ccbpb011A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB011A04-004: ruleId required');
  }
  ...
  static void executeAssignsStep5(Ccbpb011A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB011A04-005: ruleId required');
  }
  ...
  static void executeAppliesStep6(Ccbpb011A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB011A04-006: ruleId required');
  }
  ...
  static void executeTriggersStep7(Ccbpb011A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB011A04-007: ruleId required');
  }
  ...
  static void executePassesStep8(Ccbpb011A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB011A04-008: ruleId required');
  }
  ...
  static void executeStreamsStep9(Ccbpb011A04Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-CCBPB011A04-009: ruleId required');
  }
