...
class Edebs00209Pipeline {
  ...
  static void executeIngestsStep1(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-001: ruleId required');
  }
  ...
  static void executeAppliesStep2(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-002: ruleId required');
  }
  ...
  static void executeAppliesStep3(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-003: ruleId required');
  }
  ...
  static void executeSetsStep4(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-004: ruleId required');
  }
  ...
  static void executeCalculatesStep5(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-005: ruleId required');
  }
  ...
  static void executeEvaluatesStep6(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-006: ruleId required');
  }
  ...
  static void executeUpdatesStep7(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-007: ruleId required');
  }
  ...
  static void executeRecordsStep8(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-008: ruleId required');
  }
  ...
  static void executeWritesStep9(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-009: ruleId required');
  }
  ...
  static void executeCommitsStep10(Edebs00209Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty, 'EC-EDEBS00209-010: ruleId required');
  }
