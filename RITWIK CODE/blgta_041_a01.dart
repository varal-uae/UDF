...
class Blgta041A01Pipeline {
  ...
  static String executeLoadsStep1(Blgta041A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A01-001: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeValidatesStep2(Blgta041A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A01-002: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeGeneratesStep3(Blgta041A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A01-003: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeInjectsStep4(Blgta041A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A01-004: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeMapsStep5(Blgta041A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A01-005: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeEvaluatesStep6(Blgta041A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A01-006: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeRoutesStep7(Blgta041A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A01-007: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeWritesStep8(Blgta041A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A01-008: ruleId must not be empty');
    return entry.ruleId;
  }
  ...
  static String executeBroadcastsStep9(Blgta041A01Entry entry) {
    ...
    assert(entry.ruleId.isNotEmpty,
      'EC-BLGTA041A01-009: ruleId must not be empty');
    return entry.ruleId;
  }
